...
set logfile=Generate%sysname%Update.log
...
CubeGen.exe %sysdir%\CubeToolModel.cgm Templates\Model0.cgt %sysdir%\CubeModel0.cgm %sysname% >> %logfile% 2>&1
...
:ModelImport
echo Import Model.
:: First, the CubeModel has te be changed according the new structure.
