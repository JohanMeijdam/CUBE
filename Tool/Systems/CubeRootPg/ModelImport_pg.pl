			...
			switch ($NodeString[$_[0]]) {
				...
				case "ATTRIBUTE" {
					...
					while (1) {
						...
						$Sequence++;
						print IMPORT "INSERT INTO bot.v_attribute (CUBE_SEQUENCE, FK_BOT_NAME, FK_TYP_NAME, NAME, PRIMARY_KEY, CODE_DISPLAY_KEY, CODE_FOREIGN_KEY, FLAG_HIDDEN, DEFAULT_VALUE, UNCHANGEABLE, XK_ITP_NAME)\n"; 
				...
				case "DERIVATION" {
					...
					while (1) {
						...
						print IMPORT "INSERT INTO bot.v_derivation (FK_BOT_NAME, FK_TYP_NAME, FK_ATB_NAME, CUBE_TSG_TYPE, AGGREGATE_FUNCTION, XK_TYP_NAME, XK_TYP_NAME_1)\n"; 
				...
				case "DESCRIPTION_ATTRIBUTE" {
					...
					while (1) {
						...
						print IMPORT "INSERT INTO bot.v_description_attribute (FK_BOT_NAME, FK_TYP_NAME, FK_ATB_NAME, TEXT)\n"; 
				...
				case "RESTRICTION_TYPE_SPEC_ATB" {
					...
					while (1) {
						...
						print IMPORT "INSERT INTO bot.v_restriction_type_spec_atb (FK_BOT_NAME, FK_TYP_NAME, FK_ATB_NAME, INCLUDE_OR_EXCLUDE, XF_TSP_TYP_NAME, XF_TSP_TSG_CODE, XK_TSP_CODE)\n"; 
				...
				case "REFERENCE" {
					...
					while (1) {
						...
						$Sequence++;
						print IMPORT "INSERT INTO bot.v_reference (CUBE_SEQUENCE, FK_BOT_NAME, FK_TYP_NAME, NAME, PRIMARY_KEY, CODE_DISPLAY_KEY, SEQUENCE, SCOPE, UNCHANGEABLE, WITHIN_SCOPE_EXTENSION, CUBE_TSG_INT_EXT, TYPE_PREFIX, XK_BOT_NAME, XK_TYP_NAME, XK_TYP_NAME_1)\n"; 
						print IMPORT "	VALUES ($Sequence, '$_[1]', '$_[2]', '".ReplX($NodeString[$j])."', '".ReplX($NodeValue[$NodeValuePntr[$j]])."', '".ReplX($NodeValue[$NodeValuePntr[$j]+1])."', ".ReplX($NodeValue[$NodeValuePntr[$j]+2]).", '".ReplX($NodeValue[$NodeValuePntr[$j]+3])."', '".ReplX($NodeValue[$NodeValuePntr[$j]+4])."', '".ReplX($NodeValue[$NodeValuePntr[$j]+5])."', '".ReplX($NodeValue[$NodeValuePntr[$j]+6])."', '".ReplX($NodeValue[$NodeValuePntr[$j]+7])."', '".ReplX(GetXkey($j,'BUSINESS_OBJECT_TYPE','BUSINESS_OBJECT_TYPE',001))."', '".ReplX(GetXkey($j,'REFERENCE_TYPE','TYPE',001))."', '".ReplX(GetXkey($j,'REFERENCE_TYPE_WITHIN_SCOPE_OF','TYPE',001))."');\n";
						print IMPORT "\n";
						$FkeyValues[0] = $_[1];
						$FkeyValues[1] = $_[2];
				...
				case "DESCRIPTION_REFERENCE" {
					...
					while (1) {
						...
						print IMPORT "INSERT INTO bot.v_description_reference (FK_BOT_NAME, FK_TYP_NAME, FK_REF_SEQUENCE, FK_REF_BOT_NAME, FK_REF_TYP_NAME, TEXT)\n"; 
				...
				case "RESTRICTION_TYPE_SPEC_REF" {
					...
					while (1) {
						...
						print IMPORT "INSERT INTO bot.v_restriction_type_spec_ref (FK_BOT_NAME, FK_TYP_NAME, FK_REF_SEQUENCE, FK_REF_BOT_NAME, FK_REF_TYP_NAME, INCLUDE_OR_EXCLUDE, XF_TSP_TYP_NAME, XF_TSP_TSG_CODE, XK_TSP_CODE)\n"; 
				...
				case "RESTRICTION_TARGET_TYPE_SPEC" {
					...
					while (1) {
						...
						print IMPORT "INSERT INTO bot.v_restriction_target_type_spec (FK_BOT_NAME, FK_TYP_NAME, FK_REF_SEQUENCE, FK_REF_BOT_NAME, FK_REF_TYP_NAME, INCLUDE_OR_EXCLUDE, XF_TSP_TYP_NAME, XF_TSP_TSG_CODE, XK_TSP_CODE)\n"; 
						print IMPORT "	VALUES ('$_[1]', '$_[2]', $_[3], '$_[4]', '$_[5]', '".ReplX($NodeString[$j])."', '".ReplX(GetXkey($j,'TYPE_SPECIALISATION','TYPE',001))."', '".ReplX(GetXkey($j,'TYPE_SPECIALISATION','TYPE_SPECIALISATION_GROUP',001))."', '".ReplX(GetXkey($j,'TYPE_SPECIALISATION','TYPE_SPECIALISATION',001))."');\n";
						print IMPORT "\n";
						$j = $NodeNext[$j];
					}
				...
				case "SERVICE" {
					...
					while (1) {
						...
						$Sequence++;
						print IMPORT "INSERT INTO bot.v_service (CUBE_SEQUENCE, FK_BOT_NAME, FK_TYP_NAME, NAME, CUBE_TSG_DB_SCR, CLASS, ACCESSIBILITY)\n"; 
				...
				case "SERVICE_STEP" {
					...
					while (1) {
						...
						$Sequence++;
						print IMPORT "INSERT INTO bot.v_service_step (CUBE_SEQUENCE, FK_BOT_NAME, FK_TYP_NAME, FK_SRV_NAME, FK_SRV_CUBE_TSG_DB_SCR, NAME, SCRIPT_NAME)\n"; 
				...
				case "SERVICE_ARGUMENT" {
					...
					while (1) {
						...
						$Sequence++;
						print IMPORT "INSERT INTO bot.v_service_argument (CUBE_SEQUENCE, FK_BOT_NAME, FK_TYP_NAME, FK_SRV_NAME, FK_SRV_CUBE_TSG_DB_SCR, CUBE_TSG_SVA_TYPE, OPTION_NAME, INPUT_OR_OUTPUT, XK_ITP_NAME, XF_ATB_TYP_NAME, XK_ATB_NAME, XK_REF_BOT_NAME, XK_REF_TYP_NAME, XF_REF_TYP_NAME, XK_REF_SEQUENCE)\n"; 
						print IMPORT "	VALUES ($Sequence, '$_[1]', '$_[2]', '$_[3]', '$_[4]', '".ReplX($NodeString[$j])."', '".ReplX($NodeValue[$NodeValuePntr[$j]])."', '".ReplX($NodeValue[$NodeValuePntr[$j]+1])."', '".ReplX(GetXkey($j,'SERVICE_ARGUMENT_INFORMATION_TYPE','INFORMATION_TYPE',001))."', '".ReplX(GetXkey($j,'SERVICE_ARGUMENT_ATTRIBUTE','TYPE',001))."', '".ReplX(GetXkey($j,'SERVICE_ARGUMENT_ATTRIBUTE','ATTRIBUTE',001))."', '".ReplX(GetXkey($j,'SERVICE_ARGUMENT_REFERENCE','BUSINESS_OBJECT_TYPE',001))."', '".ReplX(GetXkey($j,'SERVICE_ARGUMENT_REFERENCE','TYPE',001))."', '".ReplX(GetXkey($j,'SERVICE_ARGUMENT_REFERENCE','TYPE',001))."', ".ReplX(GetXkey($j,'SERVICE_ARGUMENT_REFERENCE','REFERENCE',004)).");\n";
						print IMPORT "\n";
						$j = $NodeNext[$j];
					}
				}
				case "RESTRICTION_TYPE_SPEC_TYP" {
					...
					while (1) {
						...
						print IMPORT "INSERT INTO bot.v_restriction_type_spec_typ (FK_BOT_NAME, FK_TYP_NAME, INCLUDE_OR_EXCLUDE, XF_TSP_TYP_NAME, XF_TSP_TSG_CODE, XK_TSP_CODE)\n"; 
				...
				case "JSON_PATH" {
					...
					while (1) {
						...
						print IMPORT "INSERT INTO bot.v_json_path (CUBE_SEQUENCE, FK_BOT_NAME, FK_TYP_NAME, FK_JSN_NAME, FK_JSN_LOCATION, FK_JSN_ATB_TYP_NAME, FK_JSN_ATB_NAME, FK_JSN_TYP_NAME, CUBE_TSG_OBJ_ARR, CUBE_TSG_TYPE, NAME, LOCATION, XF_ATB_TYP_NAME, XK_ATB_NAME, XK_TYP_NAME)\n"; 
				...
				case "DESCRIPTION_TYPE" {
					...
					while (1) {
						...
						print IMPORT "INSERT INTO bot.v_description_type (FK_BOT_NAME, FK_TYP_NAME, TEXT)\n"; 
				...
				case "SYSTEM" {
					...
					while (1) {
						...
						print IMPORT "INSERT INTO sys.v_system (NAME, CUBE_TSG_TYPE, DATABASE, SCHEMA, PASSWORD, TABLE_PREFIX)\n"; 
				...
				case "SYSTEM_BO_TYPE" {
					...
					while (1) {
						...
						$Sequence++;
						print IMPORT "INSERT INTO sys.v_system_bo_type (CUBE_SEQUENCE, FK_SYS_NAME, XK_BOT_NAME)\n"; 
				...
				case "CUBE_USER" {
					print IMPORT "--\n";
					print IMPORT "-- Insert CUBE_USER business object types\n";
					print IMPORT "--\n";
					$j = $NodeFirst[$_[0]];
					while (1) {
						if ($j == -1) {
						...
						print IMPORT "INSERT INTO cube_usr.v_cube_user (USERID, NAME, PASSWORD)\n"; 
				...
				case "FUNCTION" {
					...
					while (1) {
						...
						print IMPORT "INSERT INTO fun.v_function (NAME)\n"; 
						print IMPORT "	VALUES ('".ReplX($NodeString[$j])."');\n";
						print IMPORT "\n";
						$FkeyValues[0] = ReplX($NodeString[$j]);
						$i = $NodeFirst[$j];
				...
				case "ARGUMENT" {
					...
					while (1) {
						...
						$Sequence++;
						print IMPORT "INSERT INTO fun.v_argument (CUBE_SEQUENCE, FK_FUN_NAME, NAME)\n"; 
				...
				case "CUBE_DESCRIPTION" {
					...
					while (1) {
						...
						print IMPORT "INSERT INTO cube_dsc.v_cube_description (TYPE_NAME, ATTRIBUTE_TYPE_NAME, SEQUENCE, VALUE)\n"; 
				...
				case "CUBE_GEN_DOCUMENTATION" {
					...
					while (1) {
						...
						print IMPORT "INSERT INTO cub.v_cube_gen_documentation (NAME, DESCRIPTION, DESCRIPTION_FUNCTIONS, DESCRIPTION_LOGICAL_EXPRESSION)\n"; 
						print IMPORT "	VALUES ('".ReplX($NodeString[$j])."', '".ReplX($NodeValue[$NodeValuePntr[$j]])."', '".ReplX($NodeValue[$NodeValuePntr[$j]+1])."', '".ReplX($NodeValue[$NodeValuePntr[$j]+2])."');\n";
						print IMPORT "\n";
						$FkeyValues[0] = ReplX($NodeString[$j]);
						$i = $NodeFirst[$j];
				...
				case "CUBE_GEN_PARAGRAPH" {
					...
					while (1) {
						...
						$Sequence++;
						print IMPORT "INSERT INTO cub.v_cube_gen_paragraph (CUBE_SEQUENCE, FK_CUB_NAME, ID, HEADER, DESCRIPTION, EXAMPLE)\n"; 
				...
				case "CUBE_GEN_EXAMPLE_MODEL" {
					...
					while (1) {
						...
						$Sequence++;
						print IMPORT "INSERT INTO cub.v_cube_gen_example_model (CUBE_SEQUENCE, FK_CUB_NAME, ID, HEADER, INCLUDED_OBJECT_NAMES, DESCRIPTION)\n"; 
						print IMPORT "	VALUES ($Sequence, '$_[1]', '".ReplX($NodeString[$j])."', '".ReplX($NodeValue[$NodeValuePntr[$j]])."', '".ReplX($NodeValue[$NodeValuePntr[$j]+1])."', '".ReplX($NodeValue[$NodeValuePntr[$j]+2])."');\n";
						print IMPORT "\n";
						$FkeyValues[0] = $_[1];
						$FkeyValues[1] = ReplX($NodeString[$j]);
				...
				case "CUBE_GEN_EXAMPLE_OBJECT" {
					...
					while (1) {
						...
						$Sequence++;
						print IMPORT "INSERT INTO cub.v_cube_gen_example_object (CUBE_SEQUENCE, FK_CUB_NAME, FK_CGM_ID, XK_BOT_NAME)\n"; 
				...
				case "CUBE_GEN_FUNCTION" {
					...
					while (1) {
						...
						$Sequence++;
						print IMPORT "INSERT INTO cub.v_cube_gen_function (CUBE_SEQUENCE, FK_CUB_NAME, FK_CGM_ID, ID, HEADER, DESCRIPTION, TEMPLATE)\n"; 
						print IMPORT "	VALUES ($Sequence, '$_[1]', '$_[2]', '".ReplX($NodeString[$j])."', '".ReplX($NodeValue[$NodeValuePntr[$j]])."', '".ReplX($NodeValue[$NodeValuePntr[$j]+1])."', '".ReplX($NodeValue[$NodeValuePntr[$j]+2])."');\n";
						print IMPORT "\n";
						$j = $NodeNext[$j];
					}
				...
				case "CUBE_GEN_TEMPLATE_FUNCTION" {
					...
					while (1) {
						...
						print IMPORT "INSERT INTO cub.v_cube_gen_template_function (FK_CUB_NAME, NAME, INDICATION_LOGICAL, DESCRIPTION, SYNTAX)\n"; 
