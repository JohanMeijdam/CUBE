...
print IMPORT "DELETE v_service_detail;\n";
			...
			switch ($NodeString[$_[0]]) {
				...
				case "SERVICE_DETAIL" {
					...
					while (1) {
						...
						print IMPORT "INSERT INTO v_service_detail (FK_BOT_NAME, FK_TYP_NAME, FK_SRV_NAME, FK_SRV_CUBE_TSG_DB_SCR, CUBE_TSG_ATB_REF, XF_ATB_TYP_NAME, XK_ATB_NAME, XK_REF_BOT_NAME, XK_REF_TYP_NAME, XF_REF_TYP_NAME, XK_REF_SEQUENCE)\n"; 
