...
print IMPORT "DELETE FROM bot.v_service_detail;\n";
			...
			switch ($NodeString[$_[0]]) {
				...
				case "SERVICE_DETAIL" {
					...
					while (1) {
						...
						print IMPORT "INSERT INTO bot.v_service_detail (FK_BOT_NAME, FK_TYP_NAME, FK_SRV_NAME, FK_SRV_CUBE_TSG_DB_SCR, CUBE_TSG_ATB_REF, XF_ATB_TYP_NAME, XK_ATB_NAME, XK_REF_BOT_NAME, XK_REF_TYP_NAME, XF_REF_TYP_NAME, XK_REF_SEQUENCE)\n"; 
						print IMPORT "	VALUES ('$_[1]', '$_[2]', '$_[3]', '$_[4]', '".ReplX($NodeString[$j])."', '".ReplX(GetXkey($j,'SERVICE_DETAIL_ATTRIBUTE','TYPE',001))."', '".ReplX(GetXkey($j,'SERVICE_DETAIL_ATTRIBUTE','ATTRIBUTE',001))."', '".ReplX(GetXkey($j,'SERVICE_DETAIL_REFERENCE','BUSINESS_OBJECT_TYPE',001))."', '".ReplX(GetXkey($j,'SERVICE_DETAIL_REFERENCE','TYPE',001))."', '".ReplX(GetXkey($j,'SERVICE_DETAIL_REFERENCE','TYPE',001))."', ".ReplX(GetXkey($j,'SERVICE_DETAIL_REFERENCE','REFERENCE',004)).");\n";
						print IMPORT "\n";
						$j = $NodeNext[$j];
					}
				}
