...
g_xmlhttp.onreadystatechange = function() {
	if(g_xmlhttp.readyState == 4) {
		...
		case "CREATE_RTR":
			...
			document._nodeId = 'TYP_RTR<||>'+document.getElementById("InputFkTypName").value+'<|>'+document.getElementById("InputFkRefSequence").value+'<|>'+document.getElementById("InputFkRefTypName").value+'<|>'+document.getElementById("InputXfTspTypName").value+'<|>'+document.getElementById("InputXfTspTsgCode").value+'<|>'+document.getElementById("InputXkTspCode").value;
			if (l_objNode != null) {
				if (l_objNode.firstChild._state == 'O') {
					if (l_argument[1] == null) {
						...
						var l_position = 'B';
						l_objNodePos = parent.TREE.document.getElementById('TYP_RTR<||>'+l_argument[1]);
					}
...
function InitBody() {
	...
	case "D":
		...
		document.getElementById("InputFkRefSequence").value=values[1];
		document.getElementById("InputFkRefTypName").value=values[2];
		document.getElementById("InputXfTspTypName").value=values[3];
		document.getElementById("InputXfTspTsgCode").value=values[4];
		document.getElementById("InputXkTspCode").value=values[5];
		document.getElementById("ButtonCreate").disabled=true;
		performTrans('GetRtr'+'<|||>'+document._argument);
		document.getElementById("InputFkBotName").readOnly=true;
		document.getElementById("InputFkTypName").readOnly=true;
		document.getElementById("InputFkRefSequence").readOnly=true;
		document.getElementById("InputFkRefTypName").readOnly=true;
	...
	case "N":
		...
		document.getElementById("ButtonUpdate").disabled=true;
		document.getElementById("ButtonDelete").disabled=true;
		performTrans('GetRefFkey'+'<|||>'+document._argument);
		document.getElementById("InputFkBotName").readOnly=true;
		document.getElementById("InputFkTypName").readOnly=true;
		document.getElementById("InputFkRefSequence").readOnly=true;
		document.getElementById("InputFkRefTypName").readOnly=true;
...
function CreateRtr() {
	var l_parameters = 
		...
		document.getElementById("InputFkRefSequence").value+'<|>'+
		document.getElementById("InputFkRefTypName").value+'<|>'+
	...
	performTrans('CreateRtr<|||>'+l_parameters);
}
...
function UpdateRtr() {
	var l_parameters = 
		...
		document.getElementById("InputXfTspTsgCode").value+'<|>'+
		document.getElementById("InputXkTspCode").value;
	performTrans('UpdateRtr<|||>'+l_parameters);
}
...
function DeleteRtr() {
	var l_parameters = 
		...
		document.getElementById("InputXfTspTsgCode").value+'<|>'+
		document.getElementById("InputXkTspCode").value;
	performTrans('DeleteRtr<|||>'+l_parameters);
}
...
function StartSelect001(p_event) {
	...
	var l_parameters = '0<|>'+document.getElementById("InputFkTypName").value+'<|>'+document.getElementById("InputFkRefTypName").value
...
<tr ><td><u>Reference.Sequence</u></td><td>
<input id="InputFkRefSequence" type="text" size="2" maxlength="2"></input></td></tr>
<tr ><td><u>Reference.Name</u></td><td>
<input id="InputFkRefTypName" type="text" size="30" maxlength="30" onchange="ToUpperCase(this);ReplaceSpaces(this);"></input></td></tr>
<tr ><td style="cursor:help" oncontextmenu="OpenDescBox('RESTRICT','RestrictionTypeSpecRef.IncludeOrExclude','RESTRICTION_TYPE_SPEC_REF','INCLUDE_OR_EXCLUDE',-1)">IncludeOrExclude</td><td>
