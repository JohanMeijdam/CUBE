...
g_xmlhttp.onreadystatechange = function() {
	if(g_xmlhttp.readyState == 4) {
		...
		case "CREATE_DCR":
			...
			document._nodeId = 'TYP_DCR<||>'+document.getElementById("InputFkTypName").value+'<|>'+document.getElementById("InputFkRefSequence").value+'<|>'+document.getElementById("InputFkRefTypName").value;
			if (l_objNode != null) {
...
function InitBody() {
	...
	case "D":
		...
		document.getElementById("ButtonCreate").disabled=true;
		performTrans('GetDcr'+'<|||>'+document._argument);
		document.getElementById("InputFkBotName").readOnly=true;
		document.getElementById("InputFkTypName").readOnly=true;
		document.getElementById("InputFkRefSequence").readOnly=true;
		document.getElementById("InputFkRefTypName").readOnly=true;
...
function CreateDcr() {
	...
	performTrans('CreateDcr<|||>'+l_parameters);
}
...
function UpdateDcr() {
	var l_parameters = 
		...
		document.getElementById("InputFkRefTypName").value+'<|>'+
		document.getElementById("InputText").value;
	performTrans('UpdateDcr<|||>'+l_parameters);
}
...
function DeleteDcr() {
	var l_parameters = 
		...
		document.getElementById("InputFkRefSequence").value+'<|>'+
		document.getElementById("InputFkRefTypName").value;
	performTrans('DeleteDcr<|||>'+l_parameters);
}
...
<tr ><td>Text</td></tr><tr><td colspan="2">
<textarea id="InputText" type="text" rows="5" cols="60" style="white-space:normal;" maxlength="3999"></textarea></td></tr>
<tr><td><br></td></tr>
<tr><td/><td>
