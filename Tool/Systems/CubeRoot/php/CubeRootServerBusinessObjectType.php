...
case 'GetSrvItems':
	...
	$stid = oci_parse($conn, "BEGIN pkg_bot.get_srv_sst_items (
		:p_cube_row,
		:p_fk_typ_name,
		:p_name,
		:p_cube_tsg_db_scr);
	...
	$stid = oci_parse($conn, "BEGIN pkg_bot.get_srv_svd_items (
		:p_cube_row,
		:p_fk_typ_name,
		:p_name,
		:p_cube_tsg_db_scr);
...
case 'GetSst':
	...
	$stid = oci_parse($conn, "BEGIN pkg_bot.get_sst (
		:p_cube_row,
		:p_fk_typ_name,
		:p_fk_srv_name,
...
case 'MoveSst':
	...
	$stid = oci_parse($conn, "BEGIN pkg_bot.move_sst (
		:p_cube_pos_action,
		:p_fk_typ_name,
		:p_fk_srv_name,
		:p_fk_srv_cube_tsg_db_scr,
...
case 'CreateSst':
	...
	$stid = oci_parse($conn, "BEGIN pkg_bot.insert_sst (
		:p_cube_pos_action,
		:p_fk_bot_name,
		:p_fk_typ_name,
		:p_fk_srv_name,
	...
	oci_bind_by_name($stid,":p_fk_srv_cube_tsg_db_scr",$RequestObj->Parameters->Type->FkSrvCubeTsgDbScr);
	oci_bind_by_name($stid,":p_name",$RequestObj->Parameters->Type->Name);
	oci_bind_by_name($stid,":p_script_name",$RequestObj->Parameters->Type->ScriptName);
	oci_bind_by_name($stid,":x_fk_typ_name",$RequestObj->Parameters->Ref->FkTypName);
	oci_bind_by_name($stid,":x_fk_srv_name",$RequestObj->Parameters->Ref->FkSrvName);
	oci_bind_by_name($stid,":x_fk_srv_cube_tsg_db_scr",$RequestObj->Parameters->Ref->FkSrvCubeTsgDbScr);
	oci_bind_by_name($stid,":x_name",$RequestObj->Parameters->Ref->Name);
...
case 'UpdateSst':
	...
	$stid = oci_parse($conn, "BEGIN pkg_bot.update_sst (
		:p_fk_bot_name,
		:p_fk_typ_name,
		:p_fk_srv_name,
		:p_fk_srv_cube_tsg_db_scr,
...
case 'DeleteSst':
	...
	$stid = oci_parse($conn, "BEGIN pkg_bot.delete_sst (
		:p_fk_typ_name,
		:p_fk_srv_name,
		:p_fk_srv_cube_tsg_db_scr,
		:p_name);
...
case 'GetSvd':
	...
	$stid = oci_parse($conn, "BEGIN pkg_bot.get_svd (
		:p_cube_row,
		:p_fk_typ_name,
		:p_fk_srv_name,
		:p_fk_srv_cube_tsg_db_scr,
...
case 'CreateSvd':
	...
	$stid = oci_parse($conn, "BEGIN pkg_bot.insert_svd (
		:p_fk_bot_name,
		:p_fk_typ_name,
		:p_fk_srv_name,
		:p_fk_srv_cube_tsg_db_scr,
	...
	oci_bind_by_name($stid,":p_fk_srv_name",$RequestObj->Parameters->Type->FkSrvName);
	oci_bind_by_name($stid,":p_fk_srv_cube_tsg_db_scr",$RequestObj->Parameters->Type->FkSrvCubeTsgDbScr);
	oci_bind_by_name($stid,":p_cube_tsg_atb_ref",$RequestObj->Parameters->Type->CubeTsgAtbRef);
	oci_bind_by_name($stid,":p_xf_atb_typ_name",$RequestObj->Parameters->Type->XfAtbTypName);
	oci_bind_by_name($stid,":p_xk_atb_name",$RequestObj->Parameters->Type->XkAtbName);
	oci_bind_by_name($stid,":p_xk_ref_bot_name",$RequestObj->Parameters->Type->XkRefBotName);
	oci_bind_by_name($stid,":p_xk_ref_typ_name",$RequestObj->Parameters->Type->XkRefTypName);
...
case 'UpdateSvd':
	...
	$stid = oci_parse($conn, "BEGIN pkg_bot.update_svd (
		:p_fk_bot_name,
		:p_fk_typ_name,
		:p_fk_srv_name,
		:p_fk_srv_cube_tsg_db_scr,
...
case 'DeleteSvd':
	...
	$stid = oci_parse($conn, "BEGIN pkg_bot.delete_svd (
		:p_fk_typ_name,
		:p_fk_srv_name,
		:p_fk_srv_cube_tsg_db_scr,
		:p_xf_atb_typ_name,
