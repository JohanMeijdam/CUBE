...
BEGIN
	...
	ELSE
		...
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEROOT' AND table_name = 'T_SERVICE_ARGUMENT' AND column_name = 'FK_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEROOT' AND table_name = 'T_SERVICE_ARGUMENT' AND column_name = 'FK_SRV_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEROOT' AND table_name = 'T_SERVICE_ARGUMENT' AND column_name = 'FK_SRV_CUBE_TSG_DB_SCR';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEROOT' AND table_name = 'T_SERVICE_ARGUMENT' AND column_name = 'INPUT_OR_OUTPUT';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEROOT' AND table_name = 'T_SERVICE_ARGUMENT' AND column_name = 'XK_ATB_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		END LOOP;
		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBEROOT' AND table_name = 'T_SERVICE_ARGUMENT')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
