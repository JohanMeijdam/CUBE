...
BEGIN
	...
	DBMS_OUTPUT.PUT_LINE ('				=PROPERTY:7|WithinScopeSourceOrTarget|'||REPLACE('In%20case%20of%20a%20%22within%20scope%20of%22%20type%20the%20indiction%20that%20it%20concerns%20the%20source%20type%20or%20the%20target%20type%20of%20the%20reference','%20',' ')||' Values: SRC(Source), TGT(Target);');
