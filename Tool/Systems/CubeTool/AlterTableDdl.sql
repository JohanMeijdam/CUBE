...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBETOOL' AND sequence_name = 'CUB_SEQ';
	IF l_count = 0 THEN
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBETOOL' AND sequence_name = 'CGP_SEQ';
	IF l_count = 0 THEN
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBETOOL' AND sequence_name = 'CGM_SEQ';
	IF l_count = 0 THEN
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBETOOL' AND sequence_name = 'CGO_SEQ';
	IF l_count = 0 THEN
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBETOOL' AND sequence_name = 'CGF_SEQ';
	IF l_count = 0 THEN
...
BEGIN
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_TYPE_REUSE' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_TYPE_REUSE' AND column_name = 'FK_BOT_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_TYPE_REUSE' AND column_name = 'FK_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_TYPE_REUSE' AND column_name = 'CARDINALITY';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_TYPE_REUSE' AND column_name = 'XK_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		FOR r_key IN (SELECT constraint_name FROM all_constraints WHERE owner = 'CUBETOOL' AND table_name = 'T_TYPE_REUSE' AND constraint_type IN ('P','U','R') ORDER BY constraint_type DESC)
		LOOP
			EXECUTE IMMEDIATE
		...
		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBETOOL' AND table_name = 'T_TYPE_REUSE')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
...
BEGIN
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_PARTITION' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_PARTITION' AND column_name = 'FK_BOT_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_PARTITION' AND column_name = 'FK_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_PARTITION' AND column_name = 'NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		FOR r_key IN (SELECT constraint_name FROM all_constraints WHERE owner = 'CUBETOOL' AND table_name = 'T_PARTITION' AND constraint_type IN ('P','U','R') ORDER BY constraint_type DESC)
		LOOP
			EXECUTE IMMEDIATE
		...
		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBETOOL' AND table_name = 'T_PARTITION')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
...
BEGIN
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_SUBTYPE' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_SUBTYPE' AND column_name = 'CUBE_SEQUENCE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_SUBTYPE' AND column_name = 'FK_BOT_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_SUBTYPE' AND column_name = 'FK_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_SUBTYPE' AND column_name = 'FK_PAR_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_SUBTYPE' AND column_name = 'NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		FOR r_key IN (SELECT constraint_name FROM all_constraints WHERE owner = 'CUBETOOL' AND table_name = 'T_SUBTYPE' AND constraint_type IN ('P','U','R') ORDER BY constraint_type DESC)
		LOOP
			EXECUTE IMMEDIATE
		...
		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBETOOL' AND table_name = 'T_SUBTYPE')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_tables WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_DOCUMENTATION';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_DOCUMENTATION' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_DOCUMENTATION' AND column_name = 'NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		FOR r_key IN (SELECT constraint_name FROM all_constraints WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_DOCUMENTATION' AND constraint_type IN ('P','U','R') ORDER BY constraint_type DESC)
		LOOP
			EXECUTE IMMEDIATE
		...
		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_DOCUMENTATION')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_tables WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_PARAGRAPH';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_PARAGRAPH' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_PARAGRAPH' AND column_name = 'HEADER';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_PARAGRAPH' AND column_name = 'DESCRIPTION';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		FOR r_key IN (SELECT constraint_name FROM all_constraints WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_PARAGRAPH' AND constraint_type IN ('P','U','R') ORDER BY constraint_type DESC)
		LOOP
			EXECUTE IMMEDIATE
		...
		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_PARAGRAPH')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_tables WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_EXAMPLE_MODEL';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_EXAMPLE_MODEL' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_EXAMPLE_MODEL' AND column_name = 'NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_EXAMPLE_MODEL' AND column_name = 'INCLUDED_OBJECT_NAMES';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		FOR r_key IN (SELECT constraint_name FROM all_constraints WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_EXAMPLE_MODEL' AND constraint_type IN ('P','U','R') ORDER BY constraint_type DESC)
		LOOP
			EXECUTE IMMEDIATE
		...
		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_EXAMPLE_MODEL')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_tables WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_EXAMPLE_OBJECT';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_EXAMPLE_OBJECT' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_EXAMPLE_OBJECT' AND column_name = 'FK_CGM_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_EXAMPLE_OBJECT' AND column_name = 'XK_BOT_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		FOR r_key IN (SELECT constraint_name FROM all_constraints WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_EXAMPLE_OBJECT' AND constraint_type IN ('P','U','R') ORDER BY constraint_type DESC)
		LOOP
			EXECUTE IMMEDIATE
		...
		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_EXAMPLE_OBJECT')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_tables WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_FUNCTION';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_FUNCTION' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_FUNCTION' AND column_name = 'FK_CGM_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_FUNCTION' AND column_name = 'HEADER';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_FUNCTION' AND column_name = 'DESCRIPTION';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_FUNCTION' AND column_name = 'TEMPLATE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		FOR r_key IN (SELECT constraint_name FROM all_constraints WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_FUNCTION' AND constraint_type IN ('P','U','R') ORDER BY constraint_type DESC)
		LOOP
			EXECUTE IMMEDIATE
		...
		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_FUNCTION')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
...
BEGIN
	FOR r_field IN (SELECT column_name,
		...
		DECODE(column_name,
  		...
  		FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_TYPE_REUSE')
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
	...
	'ALTER TABLE t_type_reuse ADD CONSTRAINT tyr_typ_fk
		...
		REFERENCES t_type (name)
		ON DELETE CASCADE';
	FOR r_field IN (SELECT column_name FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_TYPE_REUSE' AND column_name NOT IN (
							'CUBE_ID',
							'FK_BOT_NAME',
							'FK_TYP_NAME',
							'CARDINALITY',
...
BEGIN
	FOR r_field IN (SELECT column_name,
		...
		DECODE(column_name,
			...
			'FK_TYP_NAME',NULL,
			'NAME',NULL,NULL) new_default_value
  		FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_PARTITION')
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
	...
	'ALTER TABLE t_partition ADD CONSTRAINT par_typ_fk
		...
		REFERENCES t_type (name)
		ON DELETE CASCADE';
	FOR r_field IN (SELECT column_name FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_PARTITION' AND column_name NOT IN (
							'CUBE_ID',
							'FK_BOT_NAME',
							'FK_TYP_NAME',
							'NAME'))
...
BEGIN
	FOR r_field IN (SELECT column_name,
		...
		DECODE(column_name,
			...
			'FK_PAR_NAME',NULL,
			'NAME',NULL,NULL) new_default_value
  		FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_SUBTYPE')
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
	...
	'ALTER TABLE t_subtype ADD CONSTRAINT stp_par_fk
		...
		ON DELETE CASCADE';
	FOR r_field IN (SELECT column_name FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_SUBTYPE' AND column_name NOT IN (
							'CUBE_ID',
							'CUBE_SEQUENCE',
							'FK_BOT_NAME',
							'FK_TYP_NAME',
...
BEGIN
	FOR r_field IN (SELECT column_name,
		...
		DECODE(column_name,
			'CUBE_ID',NULL,
			'NAME',NULL,NULL) new_default_value
  		FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_DOCUMENTATION')
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
	...
	FOR r_field IN (SELECT column_name FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_DOCUMENTATION' AND column_name NOT IN (
							'CUBE_ID',
							'NAME'))
	LOOP
		EXECUTE IMMEDIATE
...
BEGIN
	FOR r_field IN (SELECT column_name,
		...
		DECODE(column_name,
  		...
  		FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_PARAGRAPH')
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
...
BEGIN
	FOR r_field IN (SELECT column_name,
		...
		DECODE(column_name,
  		...
  		FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_EXAMPLE_MODEL')
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
...
BEGIN
	FOR r_field IN (SELECT column_name,
		...
		DECODE(column_name,
			...
			'FK_CGM_NAME',NULL,
			'XK_BOT_NAME',NULL,NULL) new_default_value
  		FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_EXAMPLE_OBJECT')
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
...
BEGIN
	FOR r_field IN (SELECT column_name,
		...
		DECODE(column_name,
  		...
  		FROM all_tab_columns WHERE owner = 'CUBETOOL' AND table_name = 'T_CUBE_GEN_FUNCTION')
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
