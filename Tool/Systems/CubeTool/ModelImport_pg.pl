			...
			switch ($NodeString[$_[0]]) {
				...
				case "REFERENCE" {
					...
					while (1) {
						...
						$Sequence++;
						print IMPORT "INSERT INTO bot.v_reference (CUBE_SEQUENCE, FK_BOT_NAME, FK_TYP_NAME, NAME, PRIMARY_KEY, CODE_DISPLAY_KEY, SEQUENCE, SCOPE, UNCHANGEABLE, WITHIN_SCOPE_EXTENSION, CUBE_TSG_INT_EXT, XK_BOT_NAME, XK_TYP_NAME, XK_TYP_NAME_1)\n"; 
