...
<tr id="RowAtbName"><td style="cursor:help" oncontextmenu="parent.OpenDescBox('attrib','Attribute.Name','ATTRIBUTE','NAME',-1)"><u><div>Name</div></u></td><td><div style="max-width:30em;"><input id="InputName" type="text" maxlength="30" style="width:100%" onchange="ToUpperCase(this);ReplaceSpaces(this);"></input></div></td></tr>
<tr id="RowAtbPrimaryKey"><td style="cursor:help" oncontextmenu="parent.OpenDescBox('attrib','Attribute.PrimaryKey','ATTRIBUTE','PRIMARY_KEY',-1)"><div>PrimaryKey</div></td><td><div><select id="InputPrimaryKey" type="text">
...
<tr id="RowAtbCodeForeignKey"><td><div>CodeForeignKey</div></td><td><div><select id="InputCodeForeignKey" type="text">
	<option value=" " selected> </option>
	<option value="N">None</option>
</select></div></td></tr>
<tr id="RowAtbFlagHidden"><td><div>FlagHidden</div></td><td><div><select id="InputFlagHidden" type="text">
	<option value=" " selected> </option>
	<option value="Y">Yes</option>
	<option value="N">No</option>
</select></div></td></tr>
<tr id="RowAtbDefaultValue"><td style="cursor:help" oncontextmenu="parent.OpenDescBox('attrib','Attribute.DefaultValue','ATTRIBUTE','DEFAULT_VALUE',-1)"><div>DefaultValue</div></td><td><div style="max-width:40em;"><input id="InputDefaultValue" type="text" maxlength="40" style="width:100%"></input></div></td></tr>
<tr id="RowAtbUnchangeable"><td style="cursor:help" oncontextmenu="parent.OpenDescBox('attrib','Attribute.Unchangeable','ATTRIBUTE','UNCHANGEABLE',-1)"><div>Unchangeable</div></td><td><div><select id="InputUnchangeable" type="text">
	<option value=" " selected> </option>
	<option value="Y">Yes</option>
	<option value="N">No</option>
</select></div></td></tr>
