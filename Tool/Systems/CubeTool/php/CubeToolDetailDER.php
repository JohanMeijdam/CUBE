...
g_xmlhttp.onreadystatechange = function() {
	if(g_xmlhttp.readyState == 4) {
		...
		case "SELECT_DER":
			...
			document.getElementById("InputCubeTsgType").value=l_values[1];
			document.getElementById("InputAggregateFunction").value=l_values[2];
			document.getElementById("InputXkTypName").value=l_values[3];
			document.getElementById("InputXkTypName1").value=l_values[4];
		...
		case "CREATE_DER":
			...
			document._nodeId = 'TYP_DER<||>'+document.getElementById("InputFkTypName").value+'<|>'+document.getElementById("InputFkAtbName").value;
			if (l_objNode != null) {
...
function InitBody() {
	...
	case "D":
		...
		document.getElementById("ButtonCreate").disabled=true;
		performTrans('GetDer'+'<|||>'+document._argument);
		document.getElementById("InputFkBotName").readOnly=true;
		document.getElementById("InputFkTypName").readOnly=true;
		document.getElementById("InputFkAtbName").readOnly=true;
...
function UpdateDer() {
	var l_parameters = 
		...
		document.getElementById("InputXkTypName").value+'<|>'+
		document.getElementById("InputXkTypName1").value;
	performTrans('UpdateDer<|||>'+l_parameters);
}
...
function DeleteDer() {
	var l_parameters = 
		document.getElementById("InputFkTypName").value+'<|>'+
		document.getElementById("InputFkAtbName").value;
	performTrans('DeleteDer<|||>'+l_parameters);
}
