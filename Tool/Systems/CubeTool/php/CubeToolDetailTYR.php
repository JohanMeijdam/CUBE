...
g_xmlhttp.onreadystatechange = function() {
	if(g_xmlhttp.readyState == 4) {
		...
		case "SELECT_TYR":
			...
			document.getElementById("InputCardinality").value=l_values[1];
			break;
		case "CREATE_TYR":
			...
			document._nodeId = 'TYP_TYR<||>'+document.getElementById("InputFkTypName").value+'<|>'+document.getElementById("InputXkTypName").value;
			if (l_objNode != null) {
				if (l_objNode.firstChild._state == 'O') {
					if (l_argument[1] == null) {
						...
						var l_position = 'B';
						l_objNodePos = parent.TREE.document.getElementById('TYP_TYR<||>'+l_argument[1]);
					}
...
function InitBody() {
	...
	case "D":
		...
		document.getElementById("InputXkTypName").value=values[1];
		document.getElementById("ButtonCreate").disabled=true;
		performTrans('GetTyr'+'<|||>'+document._argument);
		document.getElementById("InputFkBotName").readOnly=true;
		document.getElementById("InputFkTypName").readOnly=true;
		document.getElementById("InputXkTypName").readOnly=true;
		document.getElementById("RefSelect001").disabled=true;
...
function CreateTyr() {
	...
	performTrans('CreateTyr<|||>'+l_parameters);
}
...
function UpdateTyr() {
	var l_parameters = 
		...
		document.getElementById("InputCardinality").value+'<|>'+
		document.getElementById("InputXkTypName").value;
	performTrans('UpdateTyr<|||>'+l_parameters);
}
...
function DeleteTyr() {
	var l_parameters = 
		document.getElementById("InputFkTypName").value+'<|>'+
		document.getElementById("InputXkTypName").value;
	performTrans('DeleteTyr<|||>'+l_parameters);
}
