...
g_xmlhttp.onreadystatechange = function() {
	if(g_xmlhttp.readyState == 4) {
		...
		case "CREATE_FUN":
			...
			document._nodeId = 'TYP_FUN<||>'+document.getElementById("InputName").value;
			if (l_objNode != null) {
...
function CreateFun() {
	...
	performTrans('CreateFun<|||>'+l_parameters);
}

function UpdateFun() {
	var l_parameters = 
		document.getElementById("InputName").value;
	performTrans('UpdateFun<|||>'+l_parameters);
}

function DeleteFun() {
	var l_parameters = 
		document.getElementById("InputName").value;
	performTrans('DeleteFun<|||>'+l_parameters);
}
