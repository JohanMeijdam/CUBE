...
g_xmlhttp.onreadystatechange = function() {
	if(g_xmlhttp.readyState == 4) {
		...
		case "CREATE_ITP":
			...
			document._nodeId = 'TYP_ITP<||>'+document.getElementById("InputName").value;
			if (l_objNode != null) {
				if (l_objNode.firstChild._state == 'O') {
					if (l_argument[1] == null) {
						...
						var l_position = 'B';
						l_objNodePos = parent.TREE.document.getElementById('TYP_ITP<||>'+l_argument[1]);
					}
...
function CreateItp() {
	...
	performTrans('CreateItp<|||>'+l_parameters);
}

function UpdateItp() {
	var l_parameters = 
		document.getElementById("InputName").value;
	performTrans('UpdateItp<|||>'+l_parameters);
}

function DeleteItp() {
	var l_parameters = 
		document.getElementById("InputName").value;
	performTrans('DeleteItp<|||>'+l_parameters);
}
