...
print IMPORT "DELETE v_function;\n";
print IMPORT "DELETE v_argument;\n";
			...
			switch ($NodeString[$_[0]]) {
				...
				case "REFERENCE" {
					...
					while (1) {
						...
						$Sequence++;
						print IMPORT "INSERT INTO v_reference (CUBE_SEQUENCE, FK_BOT_NAME, FK_TYP_NAME, NAME, PRIMARY_KEY, CODE_DISPLAY_KEY, SEQUENCE, SCOPE, UNCHANGEABLE, WITHIN_SCOPE_EXTENSION, CUBE_TSG_INT_EXT, TYPE_PREFIX, XK_BOT_NAME, XK_TYP_NAME, XK_TYP_NAME_1)\n"; 
				...
				case "SERVICE_ARGUMENT" {
					...
					while (1) {
						...
						$Sequence++;
						print IMPORT "INSERT INTO v_service_argument (CUBE_SEQUENCE, FK_BOT_NAME, FK_TYP_NAME, FK_SRV_NAME, FK_SRV_CUBE_TSG_DB_SCR, CUBE_TSG_SVA_TYPE, OPTION_NAME, INPUT_OR_OUTPUT, XK_ITP_NAME, XF_ATB_TYP_NAME, XK_ATB_NAME, XK_REF_BOT_NAME, XK_REF_TYP_NAME, XF_REF_TYP_NAME, XK_REF_SEQUENCE)\n"; 
