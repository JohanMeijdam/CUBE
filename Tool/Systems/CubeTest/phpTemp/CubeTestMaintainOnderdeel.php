...
function InitBody() {
	...
	case "N":
		...
		document.getElementById("InputFkPrdCubeTsgType").value=l_json_objectKey.TYP_<<TYPE(N-1)1>>.CubeTsgType;
		document.getElementById("InputFkPrdCode").value=l_json_objectKey.TYP_<<TYPE(N-1)1>>.Code;
		document.getElementById("ButtonUpdate").disabled=true;
		document.getElementById("ButtonDelete").disabled=true;
		document.getElementById("InputFkPrdCubeTsgType").disabled=true;
		document.getElementById("InputFkPrdCode").disabled=true;
