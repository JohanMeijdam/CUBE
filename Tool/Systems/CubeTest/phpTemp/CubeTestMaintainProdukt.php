...
<tr id="RowAtbCode"><td style="cursor:help" oncontextmenu="parent.OpenDescBox('produkt','Produkt.Code','PRODUKT','CODE',-1)"><u><div>Code</div></u></td><td><div style="max-width:8em;"><input id="InputCode" type="text" maxlength="8" style="width:100%" onchange="ToUpperCase(this);ReplaceSpaces(this);"></input></div></td></tr>
...
<tr id="RowAtbMakelaarNaam"><td><div>MakelaarNaam</div></td><td><div style="max-width:40em;"><input id="InputMakelaarNaam" type="text" maxlength="40" style="width:100%"></input></div></td></tr>
<tr id="RowAtbBedragBtw"><td><div>BedragBtw</div></td><td><div style="max-width:9em;"><input id="InputBedragBtw" type="text" maxlength="9" style="width:100%"></input></div></td></tr>
