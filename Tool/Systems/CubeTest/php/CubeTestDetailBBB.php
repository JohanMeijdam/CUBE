...
g_xmlhttp.onreadystatechange = function() {
	if(g_xmlhttp.readyState == 4) {
		...
		case "SELECT_BBB":
			...
			document.getElementById("InputXkAaaNaam").value=l_values[1];
			document.getElementById("InputXkBbbNaam1").value=l_values[2];
			break;
		case "CREATE_BBB":
...
<div><img src="icons/part_large.bmp" /><span> BBB</span></div>
<hr/>
<table>
...
<tr><td height=6></td></tr><tr><td colspan=2><fieldset><legend><img style="border:1 solid transparent;" src="icons/produkt.bmp"/> Aaa (Test)</legend>
...
<tr><td height=6></td></tr><tr><td colspan=2><fieldset><legend><img style="border:1 solid transparent;" src="icons/part.bmp"/> Bbb (RecursiveTest)</legend>
<table style="width:100%;">
<tr><td>Bbb.Naam</td><td style="width:100%;"><div style="max-width:40em;">
<input id="InputXkBbbNaam1" type="text" maxlength="40" style="width:100%;" readonly></input></div></td>
