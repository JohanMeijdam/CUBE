...
g_xmlhttp.onreadystatechange = function() {
	if(g_xmlhttp.readyState == 4) {
		...
		case "CREATE_PAR":
			...
			document._nodeId = 'TYP_PAR<||>'+document.getElementById("InputFkTypName").value+'<|>'+document.getElementById("InputName").value;
			if (l_objNode != null) {
...
function InitBody() {
	...
	case "D":
		...
		document.getElementById("ButtonCreate").disabled=true;
		performTrans('GetPar'+'<|||>'+document._argument);
		document.getElementById("ButtonUpdate").disabled=true;
		document.getElementById("InputFkBotName").readOnly=true;
		document.getElementById("InputFkTypName").readOnly=true;
		document.getElementById("InputName").readOnly=true;
...
function CreatePar() {
	...
	performTrans('CreatePar<|||>'+l_parameters);
}
...
function UpdatePar() {
	var l_parameters = 
		...
		document.getElementById("InputFkTypName").value+'<|>'+
		document.getElementById("InputName").value;
	performTrans('UpdatePar<|||>'+l_parameters);
}
...
function DeletePar() {
	var l_parameters = 
		document.getElementById("InputFkTypName").value+'<|>'+
		document.getElementById("InputName").value;
	performTrans('DeletePar<|||>'+l_parameters);
}
