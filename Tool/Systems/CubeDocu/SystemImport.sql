...
INSERT INTO v_cube_description (CUBE_ID, TYPE_NAME, ATTRIBUTE_TYPE_NAME, SEQUENCE, VALUE)
	VALUES ( 'CUBE-DCA-0100015','CUBE_GEN_DOCUMENTATION','NAME',-1,UTL_URL.UNESCAPE('The%20name%20of%20the%20document.'));
INSERT INTO v_cube_description (CUBE_ID, TYPE_NAME, ATTRIBUTE_TYPE_NAME, SEQUENCE, VALUE)
	VALUES ( 'CUBE-DCA-0100016','CUBE_GEN_DOCUMENTATION','DESCRIPTION_FUNCTIONS',-1,UTL_URL.UNESCAPE('Description%20for%20Template%20Function%20chapter.'));
INSERT INTO v_cube_description (CUBE_ID, TYPE_NAME, ATTRIBUTE_TYPE_NAME, SEQUENCE, VALUE)
	VALUES ( 'CUBE-DCA-0100017','CUBE_GEN_DOCUMENTATION','DESCRIPTION_LOGICAL_EXPRESSION',-1,UTL_URL.UNESCAPE('Description%20for%20Template%20Logical%20Functions%20chapter.'));
INSERT INTO v_cube_description (CUBE_ID, TYPE_NAME, ATTRIBUTE_TYPE_NAME, SEQUENCE, VALUE)
	VALUES ( 'CUBE-DCA-0100018','CUBE_GEN_PARAGRAPH','ID',-1,UTL_URL.UNESCAPE('Technical%20identifier.'));
INSERT INTO v_cube_description (CUBE_ID, TYPE_NAME, ATTRIBUTE_TYPE_NAME, SEQUENCE, VALUE)
	VALUES ( 'CUBE-DCA-0100019','CUBE_GEN_PARAGRAPH','HEADER',-1,UTL_URL.UNESCAPE('Text%20used%20as%20header%20and%20used%20in%20the%20index.'));
INSERT INTO v_cube_description (CUBE_ID, TYPE_NAME, ATTRIBUTE_TYPE_NAME, SEQUENCE, VALUE)
	VALUES ( 'CUBE-DCA-0100020','CUBE_GEN_PARAGRAPH','EXAMPLE',-1,UTL_URL.UNESCAPE('An%20example%20to%20explain%20the%20paragraph.%20No%20example%20is%20indicated%20by%20a%20%27%23%27.'));
INSERT INTO v_cube_description (CUBE_ID, TYPE_NAME, ATTRIBUTE_TYPE_NAME, SEQUENCE, VALUE)
...
INSERT INTO v_cube_description (CUBE_ID, TYPE_NAME, ATTRIBUTE_TYPE_NAME, SEQUENCE, VALUE)
	VALUES ( 'CUBE-DCA-0100022','CUBE_GEN_EXAMPLE_MODEL','HEADER',-1,UTL_URL.UNESCAPE('Text%20used%20as%20header%20and%20used%20in%20the%20index.'));
INSERT INTO v_cube_description (CUBE_ID, TYPE_NAME, ATTRIBUTE_TYPE_NAME, SEQUENCE, VALUE)
	VALUES ( 'CUBE-DCA-0100023','CUBE_GEN_EXAMPLE_MODEL','INCLUDED_OBJECT_NAMES',-1,UTL_URL.UNESCAPE('The%20names%20of%20types%20that%20are%20included%20in%20the%20view%20of%20the%20business%20object%20model.'));
INSERT INTO v_cube_description (CUBE_ID, TYPE_NAME, ATTRIBUTE_TYPE_NAME, SEQUENCE, VALUE)
...
INSERT INTO v_cube_description (CUBE_ID, TYPE_NAME, ATTRIBUTE_TYPE_NAME, SEQUENCE, VALUE)
	VALUES ( 'CUBE-DCA-0100024','CUBE_GEN_FUNCTION','ID',-1,UTL_URL.UNESCAPE('Technical%20identifier.'));
INSERT INTO v_cube_description (CUBE_ID, TYPE_NAME, ATTRIBUTE_TYPE_NAME, SEQUENCE, VALUE)
...
INSERT INTO v_cube_description (CUBE_ID, TYPE_NAME, ATTRIBUTE_TYPE_NAME, SEQUENCE, VALUE)
	VALUES ( 'CUBE-DCA-0100027','CUBE_GEN_TEMPLATE_FUNCTION','INDICATION_LOGICAL',-1,UTL_URL.UNESCAPE('Indication%20that%20the%20function%20is%20a%20locical%20expression%20used%20in%20a%20condition.'));
EXIT;