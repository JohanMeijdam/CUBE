...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'SQ_ITP';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE 
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'SQ_ITE';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE 
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'SQ_VAL';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE 
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'SQ_BOT';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE 
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'SQ_TYP';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE 
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'SQ_TSG';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE 
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'SQ_TSP';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE 
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'SQ_ATB';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE 
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'SQ_DER';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE 
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'SQ_DCA';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE 
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'SQ_RTA';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE 
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'SQ_REF';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE 
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'SQ_DCR';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE 
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'SQ_RTR';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE 
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'SQ_RTS';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE 
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'SQ_RTT';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE 
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'SQ_JSN';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE 
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'SQ_DCT';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE 
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'SQ_CUB';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE 
		'CREATE SEQUENCE sq_cub START WITH 100000';
		DBMS_OUTPUT.PUT_LINE('Sequence SQ_CUB created');
	END IF;
END;
/
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'SQ_CGP';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE 
		'CREATE SEQUENCE sq_cgp START WITH 100000';
		DBMS_OUTPUT.PUT_LINE('Sequence SQ_CGP created');
	END IF;
END;
/
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'SQ_CGM';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE 
		'CREATE SEQUENCE sq_cgm START WITH 100000';
		DBMS_OUTPUT.PUT_LINE('Sequence SQ_CGM created');
	END IF;
END;
/
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'SQ_CGO';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE 
		'CREATE SEQUENCE sq_cgo START WITH 100000';
		DBMS_OUTPUT.PUT_LINE('Sequence SQ_CGO created');
	END IF;
END;
/
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'SQ_CGF';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE 
		'CREATE SEQUENCE sq_cgf START WITH 100000';
		DBMS_OUTPUT.PUT_LINE('Sequence SQ_CGF created');
	END IF;
END;
/
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'SQ_CTF';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE 
		'CREATE SEQUENCE sq_ctf START WITH 100000';
		DBMS_OUTPUT.PUT_LINE('Sequence SQ_CTF created');
	END IF;
END;
/
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'SQ_SYS';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE 
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'SQ_SBT';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE 
...
BEGIN
	...
	ELSE
		...
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_REFERENCE' AND column_name = 'WITHIN_SCOPE_EXTENSION';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_REFERENCE' AND column_name = 'CUBE_TSG_INT_EXT';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_REFERENCE' AND column_name = 'XK_BOT_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
...
BEGIN
	...
	ELSE
		...
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DESCRIPTION_REFERENCE' AND column_name = 'FK_REF_BOT_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
...
BEGIN
	...
	ELSE
		...
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TYPE_SPEC_REF' AND column_name = 'FK_REF_BOT_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
...
BEGIN
	...
	SELECT COUNT(1) INTO l_count FROM all_tables WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TARGET_TYPE_SPEC';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE
	...
	ELSE
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TARGET_TYPE_SPEC' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TARGET_TYPE_SPEC' AND column_name = 'FK_BOT_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TARGET_TYPE_SPEC' AND column_name = 'FK_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TARGET_TYPE_SPEC' AND column_name = 'FK_REF_SEQUENCE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TARGET_TYPE_SPEC' AND column_name = 'FK_REF_BOT_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TARGET_TYPE_SPEC' AND column_name = 'FK_REF_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TARGET_TYPE_SPEC' AND column_name = 'INCLUDE_OR_EXCLUDE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TARGET_TYPE_SPEC' AND column_name = 'XF_TSP_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TARGET_TYPE_SPEC' AND column_name = 'XF_TSP_TSG_CODE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TARGET_TYPE_SPEC' AND column_name = 'XK_TSP_CODE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		END IF;
		FOR r_key IN (SELECT constraint_name FROM all_constraints WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TARGET_TYPE_SPEC' AND constraint_type IN ('P','U','R') ORDER BY constraint_type DESC)
		LOOP
			EXECUTE IMMEDIATE
		...
		END LOOP;
		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TARGET_TYPE_SPEC')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
...
BEGIN
	...
	SELECT COUNT(1) INTO l_count FROM all_tables WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_PATH';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE
	...
	ELSE
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_PATH' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
			'ALTER TABLE t_json_path ADD cube_id VARCHAR2(16)';
			DBMS_OUTPUT.PUT_LINE('Column T_JSON_PATH.CUBE_ID created');
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_PATH' AND column_name = 'CUBE_SEQUENCE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
			'ALTER TABLE t_json_path ADD cube_sequence NUMBER(8)';
			DBMS_OUTPUT.PUT_LINE('Column T_JSON_PATH.CUBE_SEQUENCE created');
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_PATH' AND column_name = 'CUBE_LEVEL';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
			'ALTER TABLE t_json_path ADD cube_level NUMBER(8) DEFAULT ''1''';
			DBMS_OUTPUT.PUT_LINE('Column T_JSON_PATH.CUBE_LEVEL created');
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_PATH' AND column_name = 'FK_BOT_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
			'ALTER TABLE t_json_path ADD fk_bot_name VARCHAR2(30)';
			DBMS_OUTPUT.PUT_LINE('Column T_JSON_PATH.FK_BOT_NAME created');
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_PATH' AND column_name = 'FK_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
			'ALTER TABLE t_json_path ADD fk_typ_name VARCHAR2(30)';
			DBMS_OUTPUT.PUT_LINE('Column T_JSON_PATH.FK_TYP_NAME created');
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_PATH' AND column_name = 'FK_JSN_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
			'ALTER TABLE t_json_path ADD fk_jsn_name VARCHAR2(32)';
			DBMS_OUTPUT.PUT_LINE('Column T_JSON_PATH.FK_JSN_NAME created');
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_PATH' AND column_name = 'FK_JSN_LOCATION';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_PATH' AND column_name = 'FK_JSN_ATB_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_PATH' AND column_name = 'FK_JSN_ATB_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
			'ALTER TABLE t_json_path ADD fk_jsn_atb_name VARCHAR2(30)';
			DBMS_OUTPUT.PUT_LINE('Column T_JSON_PATH.FK_JSN_ATB_NAME created');
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_PATH' AND column_name = 'FK_JSN_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
			'ALTER TABLE t_json_path ADD fk_jsn_typ_name VARCHAR2(30)';
			DBMS_OUTPUT.PUT_LINE('Column T_JSON_PATH.FK_JSN_TYP_NAME created');
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_PATH' AND column_name = 'CUBE_TSG_OBJ_ARR';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_PATH' AND column_name = 'CUBE_TSG_TYPE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_PATH' AND column_name = 'NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
			'ALTER TABLE t_json_path ADD name VARCHAR2(32)';
			DBMS_OUTPUT.PUT_LINE('Column T_JSON_PATH.NAME created');
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_PATH' AND column_name = 'LOCATION';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
			'ALTER TABLE t_json_path ADD location NUMBER(8) DEFAULT ''0''';
			DBMS_OUTPUT.PUT_LINE('Column T_JSON_PATH.LOCATION created');
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_PATH' AND column_name = 'XF_ATB_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
			'ALTER TABLE t_json_path ADD xf_atb_typ_name VARCHAR2(30)';
			DBMS_OUTPUT.PUT_LINE('Column T_JSON_PATH.XF_ATB_TYP_NAME created');
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_PATH' AND column_name = 'XK_ATB_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
			'ALTER TABLE t_json_path ADD xk_atb_name VARCHAR2(30)';
			DBMS_OUTPUT.PUT_LINE('Column T_JSON_PATH.XK_ATB_NAME created');
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_PATH' AND column_name = 'XK_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
			'ALTER TABLE t_json_path ADD xk_typ_name VARCHAR2(30)';
			DBMS_OUTPUT.PUT_LINE('Column T_JSON_PATH.XK_TYP_NAME created');
		END IF;
		FOR r_key IN (SELECT constraint_name FROM all_constraints WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_PATH' AND constraint_type IN ('P','U','R') ORDER BY constraint_type DESC)
		LOOP
			EXECUTE IMMEDIATE
		...
		END LOOP;
		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_PATH')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
...
BEGIN
	...
	ELSE
		...
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_SYSTEM' AND column_name = 'CUBE_TSG_TYPE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		END IF;
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_SYSTEM' AND column_name = 'TABLE_PREFIX';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
...
BEGIN
	...
	FOR r_field IN (SELECT column_name,
		...
		DECODE(column_name,
			...
			'XF_TSP_TSG_CODE',NULL,
			'XK_TSP_CODE',NULL,NULL) new_default_value
  		FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TARGET_TYPE_SPEC')
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
	...
	'ALTER TABLE t_restriction_target_type_spec ADD CONSTRAINT rts_ref_fk
		...
		REFERENCES t_reference (fk_typ_name, sequence, xk_bot_name, xk_typ_name)
		ON DELETE CASCADE';
	FOR r_field IN (SELECT column_name FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TARGET_TYPE_SPEC' AND column_name NOT IN (
							'CUBE_ID',
							'FK_BOT_NAME',
							'FK_TYP_NAME',
							'FK_REF_SEQUENCE',
...
BEGIN
	...
	FOR r_field IN (SELECT column_name,
		...
		DECODE(column_name,
  		...
  		FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_PATH')
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
	...
	'ALTER TABLE t_json_path ADD CONSTRAINT jsn_jsn_fk
		...
		ON DELETE CASCADE';
	FOR r_field IN (SELECT column_name FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_PATH' AND column_name NOT IN (
							'CUBE_ID',
							'CUBE_SEQUENCE',
							'CUBE_LEVEL',
							'FK_BOT_NAME',
