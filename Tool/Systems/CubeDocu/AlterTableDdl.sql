...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'ITP_SEQ';
	IF l_count = 0 THEN
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'ITE_SEQ';
	IF l_count = 0 THEN
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'VAL_SEQ';
	IF l_count = 0 THEN
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'BOT_SEQ';
	IF l_count = 0 THEN
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'TYP_SEQ';
	IF l_count = 0 THEN
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'ATB_SEQ';
	IF l_count = 0 THEN
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'DER_SEQ';
	IF l_count = 0 THEN
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'DCA_SEQ';
	IF l_count = 0 THEN
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'RTA_SEQ';
	IF l_count = 0 THEN
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'REF_SEQ';
	IF l_count = 0 THEN
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'DCR_SEQ';
	IF l_count = 0 THEN
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'RTR_SEQ';
	IF l_count = 0 THEN
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'JSN_SEQ';
	IF l_count = 0 THEN
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'JOA_SEQ';
	IF l_count = 0 THEN
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'PAR_SEQ';
	IF l_count = 0 THEN
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'STP_SEQ';
	IF l_count = 0 THEN
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'TSG_SEQ';
	IF l_count = 0 THEN
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'TSP_SEQ';
	IF l_count = 0 THEN
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'DCT_SEQ';
	IF l_count = 0 THEN
...
BEGIN
	...
	IF l_count = 0 THEN
		...
		DBMS_OUTPUT.PUT_LINE('Sequence CUB_SEQ created');
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'CGP_SEQ';
	IF l_count = 0 THEN

		EXECUTE IMMEDIATE 
		'CREATE SEQUENCE cgp_seq START WITH 100000';
		DBMS_OUTPUT.PUT_LINE('Sequence CGP_SEQ created');
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'CGM_SEQ';
	IF l_count = 0 THEN

		EXECUTE IMMEDIATE 
		'CREATE SEQUENCE cgm_seq START WITH 100000';
		DBMS_OUTPUT.PUT_LINE('Sequence CGM_SEQ created');
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'CGO_SEQ';
	IF l_count = 0 THEN

		EXECUTE IMMEDIATE 
		'CREATE SEQUENCE cgo_seq START WITH 100000';
		DBMS_OUTPUT.PUT_LINE('Sequence CGO_SEQ created');
...
DECLARE
	l_count NUMBER(4);
BEGIN
	SELECT COUNT(1) INTO l_count FROM all_sequences WHERE sequence_owner = 'CUBEDOCU' AND sequence_name = 'CGF_SEQ';
	IF l_count = 0 THEN

		EXECUTE IMMEDIATE 
		'CREATE SEQUENCE cgf_seq START WITH 100000';
		DBMS_OUTPUT.PUT_LINE('Sequence CGF_SEQ created');
...
BEGIN
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_INFORMATION_TYPE' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_INFORMATION_TYPE' AND column_name = 'NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		FOR r_key IN (SELECT constraint_name FROM all_constraints WHERE owner = 'CUBEDOCU' AND table_name = 'T_INFORMATION_TYPE' AND constraint_type IN ('P','U','R') ORDER BY constraint_type DESC)
		LOOP
			EXECUTE IMMEDIATE
		...
		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBEDOCU' AND table_name = 'T_INFORMATION_TYPE')
		LOOP
			EXECUTE IMMEDIATE
...
BEGIN
	...
	SELECT COUNT(1) INTO l_count FROM all_tables WHERE owner = 'CUBEDOCU' AND table_name = 'T_INFORMATION_TYPE_ELEMENT';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_INFORMATION_TYPE_ELEMENT' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_INFORMATION_TYPE_ELEMENT' AND column_name = 'FK_ITP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_INFORMATION_TYPE_ELEMENT' AND column_name = 'SEQUENCE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_INFORMATION_TYPE_ELEMENT' AND column_name = 'SUFFIX';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_INFORMATION_TYPE_ELEMENT' AND column_name = 'LENGTH';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_INFORMATION_TYPE_ELEMENT' AND column_name = 'DECIMALS';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_INFORMATION_TYPE_ELEMENT' AND column_name = 'CASE_SENSITIVE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_INFORMATION_TYPE_ELEMENT' AND column_name = 'DEFAULT_VALUE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_INFORMATION_TYPE_ELEMENT' AND column_name = 'SPACES_ALLOWED';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_INFORMATION_TYPE_ELEMENT' AND column_name = 'PRESENTATION';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		FOR r_key IN (SELECT constraint_name FROM all_constraints WHERE owner = 'CUBEDOCU' AND table_name = 'T_INFORMATION_TYPE_ELEMENT' AND constraint_type IN ('P','U','R') ORDER BY constraint_type DESC)
		LOOP
			EXECUTE IMMEDIATE
		...
		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBEDOCU' AND table_name = 'T_INFORMATION_TYPE_ELEMENT')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
...
BEGIN
	...
	SELECT COUNT(1) INTO l_count FROM all_tables WHERE owner = 'CUBEDOCU' AND table_name = 'T_PERMITTED_VALUE';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_PERMITTED_VALUE' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_PERMITTED_VALUE' AND column_name = 'CUBE_SEQUENCE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_PERMITTED_VALUE' AND column_name = 'FK_ITP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_PERMITTED_VALUE' AND column_name = 'FK_ITE_SEQUENCE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_PERMITTED_VALUE' AND column_name = 'PROMPT';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		FOR r_key IN (SELECT constraint_name FROM all_constraints WHERE owner = 'CUBEDOCU' AND table_name = 'T_PERMITTED_VALUE' AND constraint_type IN ('P','U','R') ORDER BY constraint_type DESC)
		LOOP
			EXECUTE IMMEDIATE
		...
		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBEDOCU' AND table_name = 'T_PERMITTED_VALUE')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
...
BEGIN
	...
	SELECT COUNT(1) INTO l_count FROM all_tables WHERE owner = 'CUBEDOCU' AND table_name = 'T_BUSINESS_OBJECT_TYPE';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_BUSINESS_OBJECT_TYPE' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_BUSINESS_OBJECT_TYPE' AND column_name = 'CUBE_SEQUENCE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_BUSINESS_OBJECT_TYPE' AND column_name = 'NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBEDOCU' AND table_name = 'T_BUSINESS_OBJECT_TYPE')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
...
BEGIN
	...
	SELECT COUNT(1) INTO l_count FROM all_tables WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE
		'CREATE TABLE t_type (
			cube_id VARCHAR2(16),
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE' AND column_name = 'CUBE_SEQUENCE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE' AND column_name = 'CUBE_LEVEL';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE' AND column_name = 'FK_BOT_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE' AND column_name = 'FK_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE' AND column_name = 'NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE' AND column_name = 'CODE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE' AND column_name = 'FLAG_RECURSIVE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE' AND column_name = 'RECURSIVE_CARDINALITY';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE' AND column_name = 'CARDINALITY';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE' AND column_name = 'SORT_ORDER';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE' AND column_name = 'ICON';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE' AND column_name = 'TRANSFERABLE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		FOR r_key IN (SELECT constraint_name FROM all_constraints WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE' AND constraint_type IN ('P','U','R') ORDER BY constraint_type DESC)
		LOOP
			EXECUTE IMMEDIATE
		...
		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
...
BEGIN
	...
	SELECT COUNT(1) INTO l_count FROM all_tables WHERE owner = 'CUBEDOCU' AND table_name = 'T_ATTRIBUTE';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_ATTRIBUTE' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_ATTRIBUTE' AND column_name = 'CUBE_SEQUENCE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_ATTRIBUTE' AND column_name = 'FK_BOT_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_ATTRIBUTE' AND column_name = 'FK_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_ATTRIBUTE' AND column_name = 'NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_ATTRIBUTE' AND column_name = 'PRIMARY_KEY';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_ATTRIBUTE' AND column_name = 'CODE_DISPLAY_KEY';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_ATTRIBUTE' AND column_name = 'CODE_FOREIGN_KEY';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_ATTRIBUTE' AND column_name = 'FLAG_HIDDEN';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_ATTRIBUTE' AND column_name = 'DEFAULT_VALUE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_ATTRIBUTE' AND column_name = 'UNCHANGEABLE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_ATTRIBUTE' AND column_name = 'XK_ITP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		FOR r_key IN (SELECT constraint_name FROM all_constraints WHERE owner = 'CUBEDOCU' AND table_name = 'T_ATTRIBUTE' AND constraint_type IN ('P','U','R') ORDER BY constraint_type DESC)
		LOOP
			EXECUTE IMMEDIATE
		...
		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBEDOCU' AND table_name = 'T_ATTRIBUTE')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
...
BEGIN
	...
	SELECT COUNT(1) INTO l_count FROM all_tables WHERE owner = 'CUBEDOCU' AND table_name = 'T_DERIVATION';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DERIVATION' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DERIVATION' AND column_name = 'FK_BOT_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DERIVATION' AND column_name = 'FK_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DERIVATION' AND column_name = 'FK_ATB_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DERIVATION' AND column_name = 'CUBE_TSG_TYPE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DERIVATION' AND column_name = 'AGGREGATE_FUNCTION';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DERIVATION' AND column_name = 'XK_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DERIVATION' AND column_name = 'XK_TYP_NAME_1';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		FOR r_key IN (SELECT constraint_name FROM all_constraints WHERE owner = 'CUBEDOCU' AND table_name = 'T_DERIVATION' AND constraint_type IN ('P','U','R') ORDER BY constraint_type DESC)
		LOOP
			EXECUTE IMMEDIATE
		...
		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBEDOCU' AND table_name = 'T_DERIVATION')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
...
BEGIN
	...
	SELECT COUNT(1) INTO l_count FROM all_tables WHERE owner = 'CUBEDOCU' AND table_name = 'T_DESCRIPTION_ATTRIBUTE';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DESCRIPTION_ATTRIBUTE' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DESCRIPTION_ATTRIBUTE' AND column_name = 'FK_BOT_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DESCRIPTION_ATTRIBUTE' AND column_name = 'FK_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DESCRIPTION_ATTRIBUTE' AND column_name = 'FK_ATB_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DESCRIPTION_ATTRIBUTE' AND column_name = 'TEXT';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		FOR r_key IN (SELECT constraint_name FROM all_constraints WHERE owner = 'CUBEDOCU' AND table_name = 'T_DESCRIPTION_ATTRIBUTE' AND constraint_type IN ('P','U','R') ORDER BY constraint_type DESC)
		LOOP
			EXECUTE IMMEDIATE
		...
		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBEDOCU' AND table_name = 'T_DESCRIPTION_ATTRIBUTE')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
...
BEGIN
	...
	SELECT COUNT(1) INTO l_count FROM all_tables WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TYPE_SPEC_ATB';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TYPE_SPEC_ATB' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TYPE_SPEC_ATB' AND column_name = 'FK_BOT_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TYPE_SPEC_ATB' AND column_name = 'FK_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TYPE_SPEC_ATB' AND column_name = 'FK_ATB_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TYPE_SPEC_ATB' AND column_name = 'INCLUDE_OR_EXCLUDE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TYPE_SPEC_ATB' AND column_name = 'XF_TSP_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		FOR r_key IN (SELECT constraint_name FROM all_constraints WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TYPE_SPEC_ATB' AND constraint_type IN ('P','U','R') ORDER BY constraint_type DESC)
		LOOP
			EXECUTE IMMEDIATE
		...
		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TYPE_SPEC_ATB')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
...
BEGIN
	...
	SELECT COUNT(1) INTO l_count FROM all_tables WHERE owner = 'CUBEDOCU' AND table_name = 'T_REFERENCE';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_REFERENCE' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_REFERENCE' AND column_name = 'CUBE_SEQUENCE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_REFERENCE' AND column_name = 'FK_BOT_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_REFERENCE' AND column_name = 'FK_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_REFERENCE' AND column_name = 'NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_REFERENCE' AND column_name = 'PRIMARY_KEY';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_REFERENCE' AND column_name = 'CODE_DISPLAY_KEY';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_REFERENCE' AND column_name = 'SEQUENCE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_REFERENCE' AND column_name = 'SCOPE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_REFERENCE' AND column_name = 'UNCHANGEABLE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_REFERENCE' AND column_name = 'WITHIN_SCOPE_LEVEL';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_REFERENCE' AND column_name = 'XK_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_REFERENCE' AND column_name = 'XK_TYP_NAME_1';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		FOR r_key IN (SELECT constraint_name FROM all_constraints WHERE owner = 'CUBEDOCU' AND table_name = 'T_REFERENCE' AND constraint_type IN ('P','U','R') ORDER BY constraint_type DESC)
		LOOP
			EXECUTE IMMEDIATE
		...
		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBEDOCU' AND table_name = 'T_REFERENCE')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
...
BEGIN
	...
	SELECT COUNT(1) INTO l_count FROM all_tables WHERE owner = 'CUBEDOCU' AND table_name = 'T_DESCRIPTION_REFERENCE';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DESCRIPTION_REFERENCE' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DESCRIPTION_REFERENCE' AND column_name = 'FK_BOT_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DESCRIPTION_REFERENCE' AND column_name = 'FK_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DESCRIPTION_REFERENCE' AND column_name = 'FK_REF_SEQUENCE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DESCRIPTION_REFERENCE' AND column_name = 'FK_REF_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DESCRIPTION_REFERENCE' AND column_name = 'TEXT';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		FOR r_key IN (SELECT constraint_name FROM all_constraints WHERE owner = 'CUBEDOCU' AND table_name = 'T_DESCRIPTION_REFERENCE' AND constraint_type IN ('P','U','R') ORDER BY constraint_type DESC)
		LOOP
			EXECUTE IMMEDIATE
		...
		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBEDOCU' AND table_name = 'T_DESCRIPTION_REFERENCE')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
...
BEGIN
	...
	SELECT COUNT(1) INTO l_count FROM all_tables WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TYPE_SPEC_REF';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TYPE_SPEC_REF' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TYPE_SPEC_REF' AND column_name = 'FK_BOT_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TYPE_SPEC_REF' AND column_name = 'FK_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TYPE_SPEC_REF' AND column_name = 'FK_REF_SEQUENCE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TYPE_SPEC_REF' AND column_name = 'FK_REF_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TYPE_SPEC_REF' AND column_name = 'INCLUDE_OR_EXCLUDE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TYPE_SPEC_REF' AND column_name = 'XF_TSP_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		FOR r_key IN (SELECT constraint_name FROM all_constraints WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TYPE_SPEC_REF' AND constraint_type IN ('P','U','R') ORDER BY constraint_type DESC)
		LOOP
			EXECUTE IMMEDIATE
		...
		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TYPE_SPEC_REF')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
...
BEGIN
	...
	SELECT COUNT(1) INTO l_count FROM all_tables WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_OBJECT';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_OBJECT' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_OBJECT' AND column_name = 'CUBE_SEQUENCE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_OBJECT' AND column_name = 'CUBE_LEVEL';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_OBJECT' AND column_name = 'FK_BOT_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_OBJECT' AND column_name = 'FK_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_OBJECT' AND column_name = 'FK_JSN_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_OBJECT' AND column_name = 'FK_JSN_LOCATION';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_OBJECT' AND column_name = 'CUBE_TSG_TYPE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_OBJECT' AND column_name = 'NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_OBJECT' AND column_name = 'LOCATION';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		FOR r_key IN (SELECT constraint_name FROM all_constraints WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_OBJECT' AND constraint_type IN ('P','U','R') ORDER BY constraint_type DESC)
		LOOP
			EXECUTE IMMEDIATE
		...
		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_OBJECT')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
...
BEGIN
	...
	SELECT COUNT(1) INTO l_count FROM all_tables WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_OBJECT_ATTRIBUTE';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_OBJECT_ATTRIBUTE' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_OBJECT_ATTRIBUTE' AND column_name = 'FK_BOT_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_OBJECT_ATTRIBUTE' AND column_name = 'FK_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_OBJECT_ATTRIBUTE' AND column_name = 'FK_JSN_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_OBJECT_ATTRIBUTE' AND column_name = 'FK_JSN_LOCATION';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_OBJECT_ATTRIBUTE' AND column_name = 'XF_ATB_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_OBJECT_ATTRIBUTE' AND column_name = 'XK_ATB_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		FOR r_key IN (SELECT constraint_name FROM all_constraints WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_OBJECT_ATTRIBUTE' AND constraint_type IN ('P','U','R') ORDER BY constraint_type DESC)
		LOOP
			EXECUTE IMMEDIATE
		...
		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_OBJECT_ATTRIBUTE')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
...
BEGIN
	...
	SELECT COUNT(1) INTO l_count FROM all_tables WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_REUSE';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_REUSE' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_REUSE' AND column_name = 'FK_BOT_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_REUSE' AND column_name = 'FK_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_REUSE' AND column_name = 'CARDINALITY';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_REUSE' AND column_name = 'XK_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		FOR r_key IN (SELECT constraint_name FROM all_constraints WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_REUSE' AND constraint_type IN ('P','U','R') ORDER BY constraint_type DESC)
		LOOP
			EXECUTE IMMEDIATE
		...
		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_REUSE')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
...
BEGIN
	...
	SELECT COUNT(1) INTO l_count FROM all_tables WHERE owner = 'CUBEDOCU' AND table_name = 'T_PARTITION';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_PARTITION' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_PARTITION' AND column_name = 'FK_BOT_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_PARTITION' AND column_name = 'FK_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_PARTITION' AND column_name = 'NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		FOR r_key IN (SELECT constraint_name FROM all_constraints WHERE owner = 'CUBEDOCU' AND table_name = 'T_PARTITION' AND constraint_type IN ('P','U','R') ORDER BY constraint_type DESC)
		LOOP
			EXECUTE IMMEDIATE
		...
		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBEDOCU' AND table_name = 'T_PARTITION')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
...
BEGIN
	...
	SELECT COUNT(1) INTO l_count FROM all_tables WHERE owner = 'CUBEDOCU' AND table_name = 'T_SUBTYPE';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_SUBTYPE' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_SUBTYPE' AND column_name = 'CUBE_SEQUENCE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_SUBTYPE' AND column_name = 'FK_BOT_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_SUBTYPE' AND column_name = 'FK_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_SUBTYPE' AND column_name = 'FK_PAR_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_SUBTYPE' AND column_name = 'NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		FOR r_key IN (SELECT constraint_name FROM all_constraints WHERE owner = 'CUBEDOCU' AND table_name = 'T_SUBTYPE' AND constraint_type IN ('P','U','R') ORDER BY constraint_type DESC)
		LOOP
			EXECUTE IMMEDIATE
		...
		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBEDOCU' AND table_name = 'T_SUBTYPE')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
...
BEGIN
	...
	SELECT COUNT(1) INTO l_count FROM all_tables WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_SPECIALISATION_GROUP';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_SPECIALISATION_GROUP' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_SPECIALISATION_GROUP' AND column_name = 'CUBE_SEQUENCE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_SPECIALISATION_GROUP' AND column_name = 'CUBE_LEVEL';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_SPECIALISATION_GROUP' AND column_name = 'FK_BOT_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_SPECIALISATION_GROUP' AND column_name = 'FK_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_SPECIALISATION_GROUP' AND column_name = 'NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_SPECIALISATION_GROUP' AND column_name = 'PRIMARY_KEY';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_SPECIALISATION_GROUP' AND column_name = 'XF_ATB_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_SPECIALISATION_GROUP' AND column_name = 'XK_ATB_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		FOR r_key IN (SELECT constraint_name FROM all_constraints WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_SPECIALISATION_GROUP' AND constraint_type IN ('P','U','R') ORDER BY constraint_type DESC)
		LOOP
			EXECUTE IMMEDIATE
		...
		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_SPECIALISATION_GROUP')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
...
BEGIN
	...
	SELECT COUNT(1) INTO l_count FROM all_tables WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_SPECIALISATION';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_SPECIALISATION' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_SPECIALISATION' AND column_name = 'CUBE_SEQUENCE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_SPECIALISATION' AND column_name = 'FK_BOT_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_SPECIALISATION' AND column_name = 'FK_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_SPECIALISATION' AND column_name = 'NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_SPECIALISATION' AND column_name = 'XF_TSP_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		FOR r_key IN (SELECT constraint_name FROM all_constraints WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_SPECIALISATION' AND constraint_type IN ('P','U','R') ORDER BY constraint_type DESC)
		LOOP
			EXECUTE IMMEDIATE
		...
		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_SPECIALISATION')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
...
BEGIN
	...
	SELECT COUNT(1) INTO l_count FROM all_tables WHERE owner = 'CUBEDOCU' AND table_name = 'T_DESCRIPTION_TYPE';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DESCRIPTION_TYPE' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DESCRIPTION_TYPE' AND column_name = 'FK_BOT_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DESCRIPTION_TYPE' AND column_name = 'FK_TYP_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DESCRIPTION_TYPE' AND column_name = 'TEXT';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		FOR r_key IN (SELECT constraint_name FROM all_constraints WHERE owner = 'CUBEDOCU' AND table_name = 'T_DESCRIPTION_TYPE' AND constraint_type IN ('P','U','R') ORDER BY constraint_type DESC)
		LOOP
			EXECUTE IMMEDIATE
		...
		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBEDOCU' AND table_name = 'T_DESCRIPTION_TYPE')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
...
DECLARE
	l_count NUMBER(4);
BEGIN
	DBMS_OUTPUT.PUT_LINE('Prepare table T_CUBE_GEN_DOCUMENTATION');
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_CUBE_GEN_DOCUMENTATION' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_documentation ADD cube_id VARCHAR2(16)';
			DBMS_OUTPUT.PUT_LINE('Column T_CUBE_GEN_DOCUMENTATION.CUBE_ID created');
		END IF;

		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_CUBE_GEN_DOCUMENTATION' AND column_name = 'NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		LOOP
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_documentation DROP CONSTRAINT ' || r_key.constraint_name || ' CASCADE';
			DBMS_OUTPUT.PUT_LINE('Primary Key T_CUBE_GEN_DOCUMENTATION.' || UPPER(r_key.constraint_name) || ' dropped');
		END LOOP;

		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBEDOCU' AND table_name = 'T_CUBE_GEN_DOCUMENTATION')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
			DBMS_OUTPUT.PUT_LINE('Index T_CUBE_GEN_DOCUMENTATION.' || UPPER(r_index.index_name) || ' dropped');
		END LOOP;
	END IF;
END;
/
DECLARE
	l_count NUMBER(4);
BEGIN
	DBMS_OUTPUT.PUT_LINE('Prepare table T_CUBE_GEN_PARAGRAPH');
	SELECT COUNT(1) INTO l_count FROM all_tables WHERE owner = 'CUBEDOCU' AND table_name = 'T_CUBE_GEN_PARAGRAPH';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_CUBE_GEN_PARAGRAPH' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_CUBE_GEN_PARAGRAPH' AND column_name = 'CUBE_SEQUENCE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_CUBE_GEN_PARAGRAPH' AND column_name = 'FK_CUB_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_paragraph ADD fk_cub_name VARCHAR2(30)';
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_CUBE_GEN_PARAGRAPH' AND column_name = 'DESCRIPTION';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		LOOP
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_paragraph DROP CONSTRAINT ' || r_key.constraint_name || ' CASCADE';
			DBMS_OUTPUT.PUT_LINE('Primary Key T_CUBE_GEN_PARAGRAPH.' || UPPER(r_key.constraint_name) || ' dropped');
		END LOOP;

		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBEDOCU' AND table_name = 'T_CUBE_GEN_PARAGRAPH')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
			DBMS_OUTPUT.PUT_LINE('Index T_CUBE_GEN_PARAGRAPH.' || UPPER(r_index.index_name) || ' dropped');
		END LOOP;
	END IF;
END;
/
DECLARE
	l_count NUMBER(4);
BEGIN
	DBMS_OUTPUT.PUT_LINE('Prepare table T_CUBE_GEN_EXAMPLE_MODEL');
	SELECT COUNT(1) INTO l_count FROM all_tables WHERE owner = 'CUBEDOCU' AND table_name = 'T_CUBE_GEN_EXAMPLE_MODEL';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_CUBE_GEN_EXAMPLE_MODEL' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_CUBE_GEN_EXAMPLE_MODEL' AND column_name = 'CUBE_SEQUENCE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_CUBE_GEN_EXAMPLE_MODEL' AND column_name = 'FK_CUB_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_example_model ADD fk_cub_name VARCHAR2(30)';
		...
		LOOP
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_example_model DROP CONSTRAINT ' || r_key.constraint_name || ' CASCADE';
			DBMS_OUTPUT.PUT_LINE('Primary Key T_CUBE_GEN_EXAMPLE_MODEL.' || UPPER(r_key.constraint_name) || ' dropped');
		END LOOP;

		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBEDOCU' AND table_name = 'T_CUBE_GEN_EXAMPLE_MODEL')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
			DBMS_OUTPUT.PUT_LINE('Index T_CUBE_GEN_EXAMPLE_MODEL.' || UPPER(r_index.index_name) || ' dropped');
		END LOOP;
	END IF;
END;
/
DECLARE
	l_count NUMBER(4);
BEGIN
	DBMS_OUTPUT.PUT_LINE('Prepare table T_CUBE_GEN_EXAMPLE_OBJECT');
	SELECT COUNT(1) INTO l_count FROM all_tables WHERE owner = 'CUBEDOCU' AND table_name = 'T_CUBE_GEN_EXAMPLE_OBJECT';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_CUBE_GEN_EXAMPLE_OBJECT' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_CUBE_GEN_EXAMPLE_OBJECT' AND column_name = 'CUBE_SEQUENCE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_CUBE_GEN_EXAMPLE_OBJECT' AND column_name = 'FK_CUB_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_example_object ADD fk_cub_name VARCHAR2(30)';
		...
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_example_object ADD xk_bot_name VARCHAR2(30)';
			DBMS_OUTPUT.PUT_LINE('Column T_CUBE_GEN_EXAMPLE_OBJECT.XK_BOT_NAME created');
		END IF;

		FOR r_key IN (SELECT constraint_name FROM all_constraints WHERE owner = 'CUBEDOCU' AND table_name = 'T_CUBE_GEN_EXAMPLE_OBJECT' AND constraint_type IN ('P','U','R') ORDER BY constraint_type DESC)
		LOOP
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_example_object DROP CONSTRAINT ' || r_key.constraint_name || ' CASCADE';
			DBMS_OUTPUT.PUT_LINE('Primary Key T_CUBE_GEN_EXAMPLE_OBJECT.' || UPPER(r_key.constraint_name) || ' dropped');
		END LOOP;

		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBEDOCU' AND table_name = 'T_CUBE_GEN_EXAMPLE_OBJECT')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
			DBMS_OUTPUT.PUT_LINE('Index T_CUBE_GEN_EXAMPLE_OBJECT.' || UPPER(r_index.index_name) || ' dropped');
		END LOOP;
	END IF;
END;
/
DECLARE
	l_count NUMBER(4);
BEGIN
	DBMS_OUTPUT.PUT_LINE('Prepare table T_CUBE_GEN_FUNCTION');
	SELECT COUNT(1) INTO l_count FROM all_tables WHERE owner = 'CUBEDOCU' AND table_name = 'T_CUBE_GEN_FUNCTION';
	IF l_count = 0 THEN
		EXECUTE IMMEDIATE
	...
	ELSE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_CUBE_GEN_FUNCTION' AND column_name = 'CUBE_ID';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_CUBE_GEN_FUNCTION' AND column_name = 'CUBE_SEQUENCE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_CUBE_GEN_FUNCTION' AND column_name = 'FK_CUB_NAME';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_function ADD fk_cub_name VARCHAR2(30)';
		...
		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_CUBE_GEN_FUNCTION' AND column_name = 'DESCRIPTION';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_function ADD description VARCHAR2(3999)';
			DBMS_OUTPUT.PUT_LINE('Column T_CUBE_GEN_FUNCTION.DESCRIPTION created');
		END IF;

		SELECT COUNT(1) INTO l_count FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_CUBE_GEN_FUNCTION' AND column_name = 'TEMPLATE';
		IF l_count = 0 THEN
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_function ADD template VARCHAR2(3999)';
			DBMS_OUTPUT.PUT_LINE('Column T_CUBE_GEN_FUNCTION.TEMPLATE created');
		END IF;

		FOR r_key IN (SELECT constraint_name FROM all_constraints WHERE owner = 'CUBEDOCU' AND table_name = 'T_CUBE_GEN_FUNCTION' AND constraint_type IN ('P','U','R') ORDER BY constraint_type DESC)
		LOOP
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_function DROP CONSTRAINT ' || r_key.constraint_name || ' CASCADE';
			DBMS_OUTPUT.PUT_LINE('Primary Key T_CUBE_GEN_FUNCTION.' || UPPER(r_key.constraint_name) || ' dropped');
		END LOOP;

		FOR r_index IN (SELECT index_name FROM all_indexes WHERE owner = 'CUBEDOCU' AND table_name = 'T_CUBE_GEN_FUNCTION')
		LOOP
			EXECUTE IMMEDIATE
			'DROP INDEX ' || r_index.index_name;
			DBMS_OUTPUT.PUT_LINE('Index T_CUBE_GEN_FUNCTION.' || UPPER(r_index.index_name) || ' dropped');
		END LOOP;
	END IF;
END;
/
DECLARE
	l_count NUMBER(4);
BEGIN
	DBMS_OUTPUT.PUT_LINE('Prepare table T_CUBE_GEN_TEMPLATE_FUNCTION');
...
BEGIN
	...
	FOR r_field IN (SELECT column_name,
		...
		DECODE(column_name,
  		...
  		FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_INFORMATION_TYPE')
	LOOP
	...
	FOR r_field IN (SELECT column_name FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_INFORMATION_TYPE' AND column_name NOT IN (
							'CUBE_ID',
							'NAME'))
	LOOP
		EXECUTE IMMEDIATE
...
BEGIN
	...
	FOR r_field IN (SELECT column_name,
		...
		DECODE(column_name,
  		...
  		FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_INFORMATION_TYPE_ELEMENT')
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
	...
	'ALTER TABLE t_information_type_element ADD CONSTRAINT ite_itp_fk
		...
		ON DELETE CASCADE';
	FOR r_field IN (SELECT column_name FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_INFORMATION_TYPE_ELEMENT' AND column_name NOT IN (
							'CUBE_ID',
							'FK_ITP_NAME',
							'SEQUENCE',
							'SUFFIX',
...
BEGIN
	...
	FOR r_field IN (SELECT column_name,
		...
		DECODE(column_name,
  		...
  		FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_PERMITTED_VALUE')
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
	...
	'ALTER TABLE t_permitted_value ADD CONSTRAINT val_ite_fk
		...
		ON DELETE CASCADE';
	FOR r_field IN (SELECT column_name FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_PERMITTED_VALUE' AND column_name NOT IN (
							'CUBE_ID',
							'CUBE_SEQUENCE',
							'FK_ITP_NAME',
							'FK_ITE_SEQUENCE',
...
BEGIN
	...
	FOR r_field IN (SELECT column_name FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_BUSINESS_OBJECT_TYPE' AND column_name NOT IN (
							'CUBE_ID',
							'CUBE_SEQUENCE',
							'NAME',
							'CUBE_TSG_TYPE',
...
BEGIN
	...
	FOR r_field IN (SELECT column_name,
		...
		DECODE(column_name,
  		...
  		FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE')
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
	...
	'ALTER TABLE t_type ADD CONSTRAINT typ_typ_fk
		...
		ON DELETE CASCADE';
	FOR r_field IN (SELECT column_name FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE' AND column_name NOT IN (
							'CUBE_ID',
							'CUBE_SEQUENCE',
							'CUBE_LEVEL',
							'FK_BOT_NAME',
...
BEGIN
	...
	FOR r_field IN (SELECT column_name,
		...
		DECODE(column_name,
  		...
  		FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_ATTRIBUTE')
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
	...
	'ALTER TABLE t_attribute ADD CONSTRAINT atb_typ_fk
		...
		REFERENCES t_type (name)
		ON DELETE CASCADE';
	FOR r_field IN (SELECT column_name FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_ATTRIBUTE' AND column_name NOT IN (
							'CUBE_ID',
							'CUBE_SEQUENCE',
							'FK_BOT_NAME',
							'FK_TYP_NAME',
...
BEGIN
	...
	FOR r_field IN (SELECT column_name,
		...
		DECODE(column_name,
  		...
  		FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DERIVATION')
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
	...
	'ALTER TABLE t_derivation ADD CONSTRAINT der_atb_fk
		...
		ON DELETE CASCADE';
	FOR r_field IN (SELECT column_name FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DERIVATION' AND column_name NOT IN (
							'CUBE_ID',
							'FK_BOT_NAME',
							'FK_TYP_NAME',
							'FK_ATB_NAME',
...
BEGIN
	...
	FOR r_field IN (SELECT column_name,
		...
		DECODE(column_name,
  		...
  		FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DESCRIPTION_ATTRIBUTE')
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
	...
	'ALTER TABLE t_description_attribute ADD CONSTRAINT dca_atb_fk
		...
		REFERENCES t_attribute (fk_typ_name, name)
		ON DELETE CASCADE';
	FOR r_field IN (SELECT column_name FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DESCRIPTION_ATTRIBUTE' AND column_name NOT IN (
							'CUBE_ID',
							'FK_BOT_NAME',
							'FK_TYP_NAME',
							'FK_ATB_NAME',
...
BEGIN
	...
	FOR r_field IN (SELECT column_name,
		...
		DECODE(column_name,
  		...
  		FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TYPE_SPEC_ATB')
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
	...
	'ALTER TABLE t_restriction_type_spec_atb ADD CONSTRAINT rta_atb_fk
		...
		REFERENCES t_attribute (fk_typ_name, name)
		ON DELETE CASCADE';
	FOR r_field IN (SELECT column_name FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TYPE_SPEC_ATB' AND column_name NOT IN (
							'CUBE_ID',
							'FK_BOT_NAME',
							'FK_TYP_NAME',
							'FK_ATB_NAME',
...
BEGIN
	...
	FOR r_field IN (SELECT column_name,
		...
		DECODE(column_name,
			...
			'XK_TYP_NAME',NULL,
			'XK_TYP_NAME_1',NULL,NULL) new_default_value
  		FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_REFERENCE')
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
	...
	'ALTER TABLE t_reference ADD CONSTRAINT ref_typ_fk
		...
		REFERENCES t_type (name)
		ON DELETE CASCADE';
	FOR r_field IN (SELECT column_name FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_REFERENCE' AND column_name NOT IN (
							'CUBE_ID',
							'CUBE_SEQUENCE',
							'FK_BOT_NAME',
							'FK_TYP_NAME',
...
BEGIN
	...
	FOR r_field IN (SELECT column_name,
		...
		DECODE(column_name,
			...
			'TEXT',NULL,NULL) new_default_value
  		FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DESCRIPTION_REFERENCE')
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
	...
	'ALTER TABLE t_description_reference ADD CONSTRAINT dcr_ref_fk
		...
		ON DELETE CASCADE';
	FOR r_field IN (SELECT column_name FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DESCRIPTION_REFERENCE' AND column_name NOT IN (
							'CUBE_ID',
							'FK_BOT_NAME',
							'FK_TYP_NAME',
							'FK_REF_SEQUENCE',
...
BEGIN
	...
	FOR r_field IN (SELECT column_name,
		...
		DECODE(column_name,
			...
			'XF_TSP_TSG_CODE',NULL,
			'XK_TSP_CODE',NULL,NULL) new_default_value
  		FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TYPE_SPEC_REF')
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
	...
	'ALTER TABLE t_restriction_type_spec_ref ADD CONSTRAINT rtr_ref_fk
		...
		REFERENCES t_reference (fk_typ_name, sequence, xk_typ_name)
		ON DELETE CASCADE';
	FOR r_field IN (SELECT column_name FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_RESTRICTION_TYPE_SPEC_REF' AND column_name NOT IN (
							'CUBE_ID',
							'FK_BOT_NAME',
							'FK_TYP_NAME',
							'FK_REF_SEQUENCE',
...
BEGIN
	...
	FOR r_field IN (SELECT column_name,
		...
		DECODE(column_name,
  		...
  		FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_OBJECT')
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
	...
	'ALTER TABLE t_json_object ADD CONSTRAINT jsn_jsn_fk
		...
		ON DELETE CASCADE';
	FOR r_field IN (SELECT column_name FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_OBJECT' AND column_name NOT IN (
							'CUBE_ID',
							'CUBE_SEQUENCE',
							'CUBE_LEVEL',
							'FK_BOT_NAME',
...
BEGIN
	...
	FOR r_field IN (SELECT column_name,
		...
		DECODE(column_name,
  		...
  		FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_OBJECT_ATTRIBUTE')
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
	...
	'ALTER TABLE t_json_object_attribute ADD CONSTRAINT joa_jsn_fk
		...
		REFERENCES t_json_object (fk_typ_name, name, location)
		ON DELETE CASCADE';
	FOR r_field IN (SELECT column_name FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_JSON_OBJECT_ATTRIBUTE' AND column_name NOT IN (
							'CUBE_ID',
							'FK_BOT_NAME',
							'FK_TYP_NAME',
							'FK_JSN_NAME',
...
BEGIN
	...
	FOR r_field IN (SELECT column_name,
		...
		DECODE(column_name,
  		...
  		FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_REUSE')
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
	...
	'ALTER TABLE t_type_reuse ADD CONSTRAINT tyr_typ_fk
		...
		REFERENCES t_type (name)
		ON DELETE CASCADE';
	FOR r_field IN (SELECT column_name FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_REUSE' AND column_name NOT IN (
							'CUBE_ID',
							'FK_BOT_NAME',
							'FK_TYP_NAME',
							'CARDINALITY',
...
BEGIN
	...
	FOR r_field IN (SELECT column_name,
		...
		DECODE(column_name,
			...
			'FK_TYP_NAME',NULL,
			'NAME',NULL,NULL) new_default_value
  		FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_PARTITION')
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
	...
	'ALTER TABLE t_partition ADD CONSTRAINT par_typ_fk
		...
		REFERENCES t_type (name)
		ON DELETE CASCADE';
	FOR r_field IN (SELECT column_name FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_PARTITION' AND column_name NOT IN (
							'CUBE_ID',
							'FK_BOT_NAME',
							'FK_TYP_NAME',
							'NAME'))
...
BEGIN
	...
	FOR r_field IN (SELECT column_name,
		...
		DECODE(column_name,
			...
			'FK_PAR_NAME',NULL,
			'NAME',NULL,NULL) new_default_value
  		FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_SUBTYPE')
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
	...
	'ALTER TABLE t_subtype ADD CONSTRAINT stp_par_fk
		...
		ON DELETE CASCADE';
	FOR r_field IN (SELECT column_name FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_SUBTYPE' AND column_name NOT IN (
							'CUBE_ID',
							'CUBE_SEQUENCE',
							'FK_BOT_NAME',
							'FK_TYP_NAME',
...
BEGIN
	...
	FOR r_field IN (SELECT column_name,
		...
		DECODE(column_name,
			...
			'XF_ATB_TYP_NAME',NULL,
			'XK_ATB_NAME',NULL,NULL) new_default_value
  		FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_SPECIALISATION_GROUP')
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
	...
	'ALTER TABLE t_type_specialisation_group ADD CONSTRAINT tsg_tsg_fk
		...
		ON DELETE CASCADE';
	FOR r_field IN (SELECT column_name FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_SPECIALISATION_GROUP' AND column_name NOT IN (
							'CUBE_ID',
							'CUBE_SEQUENCE',
							'CUBE_LEVEL',
							'FK_BOT_NAME',
...
BEGIN
	...
	FOR r_field IN (SELECT column_name,
		...
		DECODE(column_name,
			...
			'XF_TSP_TSG_CODE',NULL,
			'XK_TSP_CODE',NULL,NULL) new_default_value
  		FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_SPECIALISATION')
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
	...
	'ALTER TABLE t_type_specialisation ADD CONSTRAINT tsp_tsg_fk
		...
		REFERENCES t_type_specialisation_group (fk_typ_name, code)
		ON DELETE CASCADE';
	FOR r_field IN (SELECT column_name FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_TYPE_SPECIALISATION' AND column_name NOT IN (
							'CUBE_ID',
							'CUBE_SEQUENCE',
							'FK_BOT_NAME',
							'FK_TYP_NAME',
...
BEGIN
	...
	FOR r_field IN (SELECT column_name,
		...
		DECODE(column_name,
			...
			'FK_TYP_NAME',NULL,
			'TEXT',NULL,NULL) new_default_value
  		FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DESCRIPTION_TYPE')
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
	...
	'ALTER TABLE t_description_type ADD CONSTRAINT dct_typ_fk
		...
		REFERENCES t_type (name)
		ON DELETE CASCADE';
	FOR r_field IN (SELECT column_name FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_DESCRIPTION_TYPE' AND column_name NOT IN (
							'CUBE_ID',
							'FK_BOT_NAME',
							'FK_TYP_NAME',
							'TEXT'))
...
/
BEGIN
	DBMS_OUTPUT.PUT_LINE('Maintain table T_CUBE_GEN_DOCUMENTATION');
	FOR r_field IN (SELECT column_name,
		data_type || DECODE (data_type,'VARCHAR2','('||char_length||')','NUMBER','('||data_precision||DECODE(data_scale,0,'',','||data_scale)||')','CHAR','('||char_length||')','') old_domain,
		data_default old_default_value,
  		DECODE(column_name,
	...
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_documentation RENAME COLUMN ' || r_field.column_name || ' TO old#domain#field';
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_documentation ADD ' || r_field.column_name || ' ' || r_field.new_domain;
 			IF r_field.new_domain = 'VARCHAR2' THEN  
				EXECUTE IMMEDIATE
				'UPDATE t_cube_gen_documentation SET ' || r_field.column_name || '= TRIM(old#domain#field)';
			ELSE
				EXECUTE IMMEDIATE
				'UPDATE t_cube_gen_documentation SET ' || r_field.column_name || '= old#domain#field';
			END IF;
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_documentation DROP COLUMN old#domain#field';
			DBMS_OUTPUT.PUT_LINE('Field T_CUBE_GEN_DOCUMENTATION.' || UPPER(r_field.column_name) || ' converted from ' || r_field.old_domain || ' to ' || r_field.new_domain);
		END IF;
		IF NOT((r_field.old_default_value IS NULL AND r_field.new_default_value IS NULL) OR r_field.old_default_value = r_field.new_default_value) THEN
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_documentation MODIFY (' || r_field.column_name || ' DEFAULT ' || NVL(r_field.new_default_value,'NULL') || ')';
			DBMS_OUTPUT.PUT_LINE('Field T_CUBE_GEN_DOCUMENTATION.' || UPPER(r_field.column_name) || ' default value set to ' || NVL(r_field.new_default_value,'NULL'));
		END IF;
	END LOOP;
	EXECUTE IMMEDIATE
	'ALTER TABLE t_cube_gen_documentation ADD CONSTRAINT cub_pk
		PRIMARY KEY (
			name )';
	...
	LOOP
		...
		DBMS_OUTPUT.PUT_LINE('Field T_CUBE_GEN_DOCUMENTATION.' || UPPER(r_field.column_name) || ' dropped');
	END LOOP;
END;
/
BEGIN
	DBMS_OUTPUT.PUT_LINE('Maintain table T_CUBE_GEN_PARAGRAPH');
	FOR r_field IN (SELECT column_name,
		data_type || DECODE (data_type,'VARCHAR2','('||char_length||')','NUMBER','('||data_precision||DECODE(data_scale,0,'',','||data_scale)||')','CHAR','('||char_length||')','') old_domain,
		data_default old_default_value,
  		DECODE(column_name,
	...
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_paragraph RENAME COLUMN ' || r_field.column_name || ' TO old#domain#field';
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_paragraph ADD ' || r_field.column_name || ' ' || r_field.new_domain;
 			IF r_field.new_domain = 'VARCHAR2' THEN  
				EXECUTE IMMEDIATE
				'UPDATE t_cube_gen_paragraph SET ' || r_field.column_name || '= TRIM(old#domain#field)';
			ELSE
				EXECUTE IMMEDIATE
				'UPDATE t_cube_gen_paragraph SET ' || r_field.column_name || '= old#domain#field';
			END IF;
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_paragraph DROP COLUMN old#domain#field';
			DBMS_OUTPUT.PUT_LINE('Field T_CUBE_GEN_PARAGRAPH.' || UPPER(r_field.column_name) || ' converted from ' || r_field.old_domain || ' to ' || r_field.new_domain);
		END IF;
		IF NOT((r_field.old_default_value IS NULL AND r_field.new_default_value IS NULL) OR r_field.old_default_value = r_field.new_default_value) THEN
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_paragraph MODIFY (' || r_field.column_name || ' DEFAULT ' || NVL(r_field.new_default_value,'NULL') || ')';
			DBMS_OUTPUT.PUT_LINE('Field T_CUBE_GEN_PARAGRAPH.' || UPPER(r_field.column_name) || ' default value set to ' || NVL(r_field.new_default_value,'NULL'));
		END IF;
	END LOOP;
	EXECUTE IMMEDIATE
	...
	'ALTER TABLE t_cube_gen_paragraph ADD CONSTRAINT cgp_cub_fk
		...
		ON DELETE CASCADE';
	FOR r_field IN (SELECT column_name FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_CUBE_GEN_PARAGRAPH' AND column_name NOT IN (
							'CUBE_ID',
							'CUBE_SEQUENCE',
							'FK_CUB_NAME',
							'ID',
	...
	LOOP
		...
		DBMS_OUTPUT.PUT_LINE('Field T_CUBE_GEN_PARAGRAPH.' || UPPER(r_field.column_name) || ' dropped');
	END LOOP;
END;
/
BEGIN
	DBMS_OUTPUT.PUT_LINE('Maintain table T_CUBE_GEN_EXAMPLE_MODEL');
	FOR r_field IN (SELECT column_name,
		data_type || DECODE (data_type,'VARCHAR2','('||char_length||')','NUMBER','('||data_precision||DECODE(data_scale,0,'',','||data_scale)||')','CHAR','('||char_length||')','') old_domain,
		data_default old_default_value,
  		DECODE(column_name,
	...
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_example_model RENAME COLUMN ' || r_field.column_name || ' TO old#domain#field';
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_example_model ADD ' || r_field.column_name || ' ' || r_field.new_domain;
 			IF r_field.new_domain = 'VARCHAR2' THEN  
				EXECUTE IMMEDIATE
				'UPDATE t_cube_gen_example_model SET ' || r_field.column_name || '= TRIM(old#domain#field)';
			ELSE
				EXECUTE IMMEDIATE
				'UPDATE t_cube_gen_example_model SET ' || r_field.column_name || '= old#domain#field';
			END IF;
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_example_model DROP COLUMN old#domain#field';
			DBMS_OUTPUT.PUT_LINE('Field T_CUBE_GEN_EXAMPLE_MODEL.' || UPPER(r_field.column_name) || ' converted from ' || r_field.old_domain || ' to ' || r_field.new_domain);
		END IF;
		IF NOT((r_field.old_default_value IS NULL AND r_field.new_default_value IS NULL) OR r_field.old_default_value = r_field.new_default_value) THEN
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_example_model MODIFY (' || r_field.column_name || ' DEFAULT ' || NVL(r_field.new_default_value,'NULL') || ')';
			DBMS_OUTPUT.PUT_LINE('Field T_CUBE_GEN_EXAMPLE_MODEL.' || UPPER(r_field.column_name) || ' default value set to ' || NVL(r_field.new_default_value,'NULL'));
		END IF;
	END LOOP;
	EXECUTE IMMEDIATE
	...
	'ALTER TABLE t_cube_gen_example_model ADD CONSTRAINT cgm_cub_fk
		...
		REFERENCES t_cube_gen_documentation (name)
		ON DELETE CASCADE';
	FOR r_field IN (SELECT column_name FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_CUBE_GEN_EXAMPLE_MODEL' AND column_name NOT IN (
							'CUBE_ID',
							'CUBE_SEQUENCE',
							'FK_CUB_NAME',
							'ID',
	...
	LOOP
		...
		DBMS_OUTPUT.PUT_LINE('Field T_CUBE_GEN_EXAMPLE_MODEL.' || UPPER(r_field.column_name) || ' dropped');
	END LOOP;
END;
/
BEGIN
	DBMS_OUTPUT.PUT_LINE('Maintain table T_CUBE_GEN_EXAMPLE_OBJECT');
	FOR r_field IN (SELECT column_name,
		data_type || DECODE (data_type,'VARCHAR2','('||char_length||')','NUMBER','('||data_precision||DECODE(data_scale,0,'',','||data_scale)||')','CHAR','('||char_length||')','') old_domain,
		data_default old_default_value,
  		DECODE(column_name,
	...
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_example_object RENAME COLUMN ' || r_field.column_name || ' TO old#domain#field';
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_example_object ADD ' || r_field.column_name || ' ' || r_field.new_domain;
 			IF r_field.new_domain = 'VARCHAR2' THEN  
				EXECUTE IMMEDIATE
				'UPDATE t_cube_gen_example_object SET ' || r_field.column_name || '= TRIM(old#domain#field)';
			ELSE
				EXECUTE IMMEDIATE
				'UPDATE t_cube_gen_example_object SET ' || r_field.column_name || '= old#domain#field';
			END IF;
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_example_object DROP COLUMN old#domain#field';
			DBMS_OUTPUT.PUT_LINE('Field T_CUBE_GEN_EXAMPLE_OBJECT.' || UPPER(r_field.column_name) || ' converted from ' || r_field.old_domain || ' to ' || r_field.new_domain);
		END IF;
		IF NOT((r_field.old_default_value IS NULL AND r_field.new_default_value IS NULL) OR r_field.old_default_value = r_field.new_default_value) THEN
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_example_object MODIFY (' || r_field.column_name || ' DEFAULT ' || NVL(r_field.new_default_value,'NULL') || ')';
			DBMS_OUTPUT.PUT_LINE('Field T_CUBE_GEN_EXAMPLE_OBJECT.' || UPPER(r_field.column_name) || ' default value set to ' || NVL(r_field.new_default_value,'NULL'));
		END IF;
	END LOOP;
	EXECUTE IMMEDIATE
	...
	LOOP
		EXECUTE IMMEDIATE
		'ALTER TABLE t_cube_gen_example_object DROP COLUMN ' || r_field.column_name;
		DBMS_OUTPUT.PUT_LINE('Field T_CUBE_GEN_EXAMPLE_OBJECT.' || UPPER(r_field.column_name) || ' dropped');
	END LOOP;
END;
/
BEGIN
	DBMS_OUTPUT.PUT_LINE('Maintain table T_CUBE_GEN_FUNCTION');
	FOR r_field IN (SELECT column_name,
		data_type || DECODE (data_type,'VARCHAR2','('||char_length||')','NUMBER','('||data_precision||DECODE(data_scale,0,'',','||data_scale)||')','CHAR','('||char_length||')','') old_domain,
		data_default old_default_value,
  		DECODE(column_name,
		...
		DECODE(column_name,
  		...
  		FROM all_tab_columns WHERE owner = 'CUBEDOCU' AND table_name = 'T_CUBE_GEN_FUNCTION')
	LOOP
		IF r_field.old_domain <> r_field.new_domain THEN
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_function RENAME COLUMN ' || r_field.column_name || ' TO old#domain#field';
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_function ADD ' || r_field.column_name || ' ' || r_field.new_domain;
 			IF r_field.new_domain = 'VARCHAR2' THEN  
				EXECUTE IMMEDIATE
				'UPDATE t_cube_gen_function SET ' || r_field.column_name || '= TRIM(old#domain#field)';
			ELSE
				EXECUTE IMMEDIATE
				'UPDATE t_cube_gen_function SET ' || r_field.column_name || '= old#domain#field';
			END IF;
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_function DROP COLUMN old#domain#field';
			DBMS_OUTPUT.PUT_LINE('Field T_CUBE_GEN_FUNCTION.' || UPPER(r_field.column_name) || ' converted from ' || r_field.old_domain || ' to ' || r_field.new_domain);
		END IF;
		IF NOT((r_field.old_default_value IS NULL AND r_field.new_default_value IS NULL) OR r_field.old_default_value = r_field.new_default_value) THEN
			EXECUTE IMMEDIATE
			'ALTER TABLE t_cube_gen_function MODIFY (' || r_field.column_name || ' DEFAULT ' || NVL(r_field.new_default_value,'NULL') || ')';
			DBMS_OUTPUT.PUT_LINE('Field T_CUBE_GEN_FUNCTION.' || UPPER(r_field.column_name) || ' default value set to ' || NVL(r_field.new_default_value,'NULL'));
		END IF;
	END LOOP;
	EXECUTE IMMEDIATE
...
/
BEGIN
	DBMS_OUTPUT.PUT_LINE('Maintain table T_CUBE_GEN_TEMPLATE_FUNCTION');
	FOR r_field IN (SELECT column_name,
		data_type || DECODE (data_type,'VARCHAR2','('||char_length||')','NUMBER','('||data_precision||DECODE(data_scale,0,'',','||data_scale)||')','CHAR','('||char_length||')','') old_domain,
		data_default old_default_value,
  		DECODE(column_name,
