						...
						if (l_objNode != null) {
							if (l_objNode.firstChild._state == 'O') {
								if (l_json_array[i].Rows.length == 0) {
									...
									var l_position = 'B';
									var l_objNodePos = parent.document.getElementById('{"TYP_CUBE_USR":'+JSON.stringify(l_json_array[i].Rows[0].Key)+'}');
								}
								parent.AddTreeviewNode(
									...
									'icons/user.bmp',
									'CubeUser',
									document.getElementById("InputUserid").value.toLowerCase(),
									'N',
									l_position,
									l_objNodePos);
							}
...
<hr/>
<table>
<tr id="RowAtbUserid"><td><u><div>Userid</div></u></td><td><div style="max-width:16em;"><input id="InputUserid" type="text" maxlength="16" style="width:100%" onchange="SetChangePending();ReplaceSpaces(this);"></input></div></td></tr>
...
<tr id="RowAtbName"><td><div>Name</div></td><td><div style="max-width:80em;"><input id="InputName" type="text" maxlength="80" style="width:100%" onchange="SetChangePending();"></input></div></td></tr>
