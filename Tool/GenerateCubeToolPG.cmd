...
::psql -h 82.217.5.32 -p 32781 -d cubetool -U cubetool -f %sysdir%\TableDdl_pg.sql >> %logfile% 2>&1
...
::set PGPASSWORD=H00rnse_H0p
::psql -h 82.217.5.32 -p 32781 -d cubetool -U cubetool -f %sysdir%\ViewDdl_pg.sql >> %logfile% 2>&1
